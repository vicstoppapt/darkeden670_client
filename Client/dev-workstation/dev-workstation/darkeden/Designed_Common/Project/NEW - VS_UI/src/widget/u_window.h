...
public:
	...
	void					SetWindowName(const char* name) { m_window_name = name; }
	const std::string		GetWindowName() { return m_window_name; }
...
public:
	...
	int		GetCurrentMouse_x()	{	return m_current_mouse_x ; }
	int		GetCurrentMouse_y()	{	return m_current_mouse_y ; }
