...
//	std::ifstream				m_slayer_ispk_file;
//	std::ifstream				m_vampire_ispk_file;
...
private:
	...
	WORD						m_wSelect_World_Index;
	WORD						m_wSelect_Chenel_Index;

	WORD						m_wSelect_World_Bar_X;
	WORD						m_wSelect_World_Bar_Y;

	WORD						m_wSelect_Chenel_Bar_X;
	WORD						m_wSelect_Chenel_Bar_Y;
