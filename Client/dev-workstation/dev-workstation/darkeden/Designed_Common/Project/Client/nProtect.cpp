...
//20081223 각 국가 버젼 별로 .ini파일 이름을 다르게 설정할경우 아래 인자값을 변경 하여 이용한다.
...
//#endif
	...
	{
		MessageBox(g_hWnd, "게임가드가 실행 중 이지 않습니다. 비정상적으로 종료 됩니다.", "Error", MB_OK|MB_ICONERROR);
		return NPROTECT_ERROR;
	}
...
int		RunNPROTECT()
{	
	//zzi - 클로벌 서비스에는 nProtect를 안 쓴다고 한다. 무조건.. OK....
...
//		default :
			...
			wsprintf(msg, "게임가드 실행 중 에러가 발생하였습니다. 게임 폴더 안의 GameGuard 폴더에 있는 *.erl 파일들을 Game1@inca.co.kr로 첨부하여 메일 보내주시기 바랍니다.") ; 
