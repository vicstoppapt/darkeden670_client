...
#define FADE_DELAY_POSTION_FRONT			0x01
#define FADE_DELAY_POSTION_BACK				0x02
...
enum EVENT_ID
{
	...
	EVENTID_WAR_EFFECT,						// 종족전 시작 전에 나오는 이벤트 - 전운이 감돌게..
	EVENTID_ADVANCEMENT_QUEST_ENDING,		// 승직 퀘스트 엔딩 이벤트
	EVENTID_LOST_CHILD_PROLOGUE,			// 로스트 차일드 프롤로그 스크린
	EVENTID_FADE_OUT,						// 페이드 아웃 페이드 인은EVENTID_GDR_PRESENT으로 사용 하고 있다.
	EVENTID_MAX,
};
