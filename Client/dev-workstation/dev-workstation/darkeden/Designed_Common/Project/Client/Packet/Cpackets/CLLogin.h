...
public :
	...
	const int getRealIpaddr () const throw () { return m_realIpaddr; }
	void setRealIpaddr ( int ipaddr ) throw () { m_realIpaddr = ipaddr; }
...
public :
	...
	PacketSize_t getPacketMaxSize () const throw () { return szBYTE + 30 + szBYTE + 20 + szint + szBYTE; }
