...
public:
	...
	BYTE getServerIDA() const throw() { return m_ServerIDA; }
	void setServerIDA(BYTE ServerIDA) throw() { m_ServerIDA = ServerIDA; }

	BYTE getServerIDB() const throw() { return m_ServerIDB; }
	void setServerIDB(BYTE ServerIDB) throw() { m_ServerIDB = ServerIDB; }

	BYTE getServerIDC() const throw() { return m_ServerIDC; }
	void setServerIDC(BYTE ServerIDC) throw() { m_ServerIDC = ServerIDC; }
