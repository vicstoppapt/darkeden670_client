...
public :
   ...
   void write(SocketOutputStream & oStream) const throw(ProtocolException, Error);
	...
	PacketSize_t getPacketSize() const throw() { return szObjectID+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketSize(); }

	// get packet's name
	string getPacketName() const throw() { return "GCSkillToObjectOK2"; }
...
public :
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const throw() { return szObjectID+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketMaxSize(); }
};
