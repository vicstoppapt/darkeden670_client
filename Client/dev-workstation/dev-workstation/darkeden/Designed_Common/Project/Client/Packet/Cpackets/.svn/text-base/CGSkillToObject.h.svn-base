...
public:
	...
	PacketSize_t getPacketSize() const throw() { return szSkillType + szCEffectID + szObjectID + szBYTE; }
...
public:
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const throw() { return szSkillType + szCEffectID + szObjectID + szBYTE; }
};
