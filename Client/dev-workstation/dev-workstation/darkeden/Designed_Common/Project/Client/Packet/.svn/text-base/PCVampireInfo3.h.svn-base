...
public:
	...
	Color_t getAdvanceBatColor () const throw () { return m_Colors[VAMPIRE_COLOR_ADVANCE_BAT]; }
	void setAdvanceBatColor (Color_t batColor) throw () { m_Colors[VAMPIRE_COLOR_ADVANCE_BAT] = batColor; }

#if __CONTENTS(__FAST_TRANSFORTER||__SECOND_TRANSFORTER)
	Color_t getWingColor () const throw () { return m_Colors[VAMPIRE_COLOR_WING1]; }
	void	setWingColor (Color_t batColor) throw () { m_Colors[VAMPIRE_COLOR_WING1] = batColor; }
	
	Color_t getWingEffectColor () const throw () { return m_Colors[VAMPIRE_COLOR_WING2]; }
