...
public :
	...
	PacketSize_t getPacketSize () const throw () { return szObjectID + szCoord + szCoord + szDir + szBYTE; }
	...
	BYTE getActionStep() const throw()	{ return m_ActionStep;		}
...
public :
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const throw() { return szObjectID + szCoord + szCoord + szDir + szBYTE; }
