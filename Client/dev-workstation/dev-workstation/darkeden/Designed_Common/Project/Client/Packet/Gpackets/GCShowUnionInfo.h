...
struct SingleGuildInfo
{
	...
	WORD getGuildMemberCount() const throw() { return m_GuildMemberCount; }
	void setGuildMemberCount( WORD GuildMemberCount ) throw() { m_GuildMemberCount = GuildMemberCount; }
...
public :
	...
	SingleGuildInfo* popFrontUnionGuildInfoList() throw()
	{
