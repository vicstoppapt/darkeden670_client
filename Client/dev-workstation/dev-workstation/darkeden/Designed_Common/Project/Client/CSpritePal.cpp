...
bool MPalette555::LoadFromFile(ivfstream &file)
{
	Release();
...
bool MPalette565::LoadFromFile(ivfstream &file)
{
	Release();
...
bool MPalettePack::LoadFromFile(ivfstream &file, bool b565)
{
	Release();
...
bool CSpritePal::LoadFromFile(ivfstream &file)
{
	Release();
...
bool CSpritePalPack::LoadFromFile(ivfstream &file)
{
	Release();
