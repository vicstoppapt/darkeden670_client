...
//	버그 수정으로 확정 될시 코드 주석을 풀자.
//	(*g_pGameStringTable)[STRING_MESSAGE_NPC_NOT_EXIST] = "NPC가 존재 하지 않습니다.";					// GCShopBuyFailHandler에러 문구 추가 (2008.08.26) shootkj
//	(*g_pGameStringTable)[STRING_MESSAGE_NOT_NPC] = "판매 NPC가 아닙니다.";								// GCShopBuyFailHandler에러 문구 추가 (2008.08.26) shootkj
//	(*g_pGameStringTable)[STRING_MESSAGE_ITEM_NOT_EXIST] = "지정한 위치에 아이템이 존재 하지 않습니다.";// GCShopBuyFailHandler에러 문구 추가 (2008.08.26) shootkj
	...
	(*g_pGameStringTable)[STRING_ERROR_INSPECTING_SERVER_ERROR] = "서버 점검중 입니다. 잠시만 기다려 주세요.";
	(*g_pGameStringTable)[STRING_ERROR_BLITZ_CONNECT_SERVER_ERROR] = "프리미엄 사용자일 때 블리츠 서버에 접속 할 수 있습니다.";	
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_RESURRECTION] = "지정 위치에서 부활합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EVACUATION]	= "지정 위치로 후송됩니다.";		
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BASIC_HELP] = "기본 도움말(Basic Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHATTING_HELP] = "채팅 도움말(Chatting Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_WAR_HELP] = "전투 도움말(Combat Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SKILL_HELP] = "기술 도움말(Skill Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_HELP] = "팀 도움말(Team Help)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_HELP] = "클랜 도움말(Clan Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MAGIC_HELP] = "마법 도움말(Magic Help)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VRANCO]="브랑코";
...
//	(*g_pGameStringTable)[UI_STRING_MESSAGE_UNKNOW]	= "알 수 없음";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_MAGICPROTECTION]="마법방어력 : ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_ONLY_OUSTERS] = "아우스터즈 전용";
...
//	(*g_pGameStringTable)[UI_STRING_MESSAGE_EVENT_QUEST_5] = "5.아우스터즈와의 조우\\n목적:아우스터즈를 부활시킬 정령석 찾기";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_HELP] = "길드 도움말(Guild Help)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_1] = "HP 흡수+15";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_2] = "HP+50, 모든능력치+7";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_3] = "물리/마법공격데미지+10";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_4] = "HP 흡수+15";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_5] = "시야+5, 모든능력치+7";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_6] = "물리/마법공격데미지+10";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_7] = "HP 흡수+15";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_8] = "시야+5, 모든능력치+7";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_9] = "물리/마법공격데미지+10";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_10] = "HP 흡수+15";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_11] = "시야+5, 모든능력치+7";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_12] = "물리/마법공격데미지+10";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_SUCCESS_CHANGED_ADVANCE_BAT_COLOR] = "승직 캐릭터 박쥐색이 변경되었습니다.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_CAN_CUT_HEAD] = "머리 루팅 가능";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_CANNOT_CUT_HEAD] = "머리 루팅 불가능";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANNOT_USE] = "사용 할 수 없습니다.";
	//end
	...
	(*g_pGameStringTable)[STRING_MESSAGE_RACE_WAR_STARTED_IN_OTHER_SERVER] = "전쟁이 시작 되었습니다. 전쟁에 참여 하시려면 트랜실베니아 에서는 아케론 서버로 브라쇼브 에서는 룬 서버로 이동하시면 됩니다. 종족간의 전쟁에서 많은 수의 성서를 확보해야 합니다.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PERSONAL_STORE] = "개인 상점(Personal Store)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_POWER_JJANG] = "파워짱(Power JJang)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_11] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_12] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_13] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_14] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_15] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_16] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_17] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_18] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_19] = "눈 %d등급";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_20] = "눈 %d등급";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAMPAIGN_HELP_THANKS] = "기부해 주신 금액은 온정의 손길이 필요한 불우한 이웃을 위해 소중하게 쓰여질 것입니다. \n모금에 참여해 주셔서 감사합니다.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_11] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_12] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_13] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_14] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_15] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_16] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_17] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_18] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_19] = "눈 %d등급 이상";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_ADVANCEMENT_LEVEL_20] = "눈 %d등급 이상";//瘻斂狼헹膠틔된섬
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_RECEIVE_OK] = "이벤트 아이템을 받았습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_RECEIVE_ALREADY] = "이미 이벤트 아이템을 수령하셨습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_RECEIVE_FAIL] = "이벤트 아이템 받기에 실패하였습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_NOT_EVENT_USER] = "이벤트 해당 유저가 아닙니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_NOTICE] = "축하합니다! 이벤트 상품이 지급되었습니다.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANNOT_USE_HIGH_GRADE] = "%d급 이상 아이템은 인챈트 할 수 없습니다.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_AVAILABLE] = "서버 통합 준비로 인해 현재 지원하지 않는 기능입니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVERNAME_MOLDAVIA] = "몰다비아";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVERNAME_TRANSILVANIA] = "트렌실베니아";	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVERNAME_WALAKIA] = "왈라키아";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVERNAME_HISTRIA] = "히스트리아";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVERNAME_NEWWOLRD] = "브라쇼브";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_PKSERVER_AGREEMENT] = "선택 하신 서버는 사용자 간에 상호 동의 없이 공격이 가능한 서버입니다. 따라서 타 사용자의 공격행위를 동의하지 않고는 입장하실 수 없습니다. 타인의 공격행위를 동의하시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NONPKSERVER_USE] = "게임 플레이 중 타 사용자로부터의 공격을 원하지 않으시는 경우 Non PK 서버를 이용하시기 바랍니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PKSERVER_USE] = "현재 맵은 사용자 간에 PK가 가능한 지역입니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_HOODLUM_STIGMA] = "HP 30% 감소 (성향 회복시 까지)";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_KEYSETTING_INIT] = "모든 캐릭터의 설정이 초기화 됩니다. 초기화 하시겠습니까?" ; 
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DARKEDEN_MARKET] = "다덴마켓";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOPPING_BASKET] = "장바구니";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_SUMMER_COMEBACK2006_LOGIN_AFTER] = "축하합니다! COME BACK, 2006 이벤트 대상자이십니다.\n\n이벤트기간 내 로그인 시점부터 5일간 프리미엄 혜택을 받을 수 있답니다.\n\n또한 이벤트 기념 아이템도 획득하실 수 있으니 해당 종족의NPC를 찾아가시기 바랍니다. \n\n(단, 이벤트 아이템은 한 계정당 한캐릭터에 한해서만 받을 수 있습니다.)\n\n*이벤트NPC\n\n슬레이어: 크리스틴 (성직자길드1층)\n\n뱀파이어: 쎄쓰 (림보성내부)\n\n아우스터즈: 호라 (아우스터즈 마을내부)\n\n";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SUMMER_COMEBACK2006_SETTLEMENT_AFTER] = "결제가 성공적으로 이루어졌습니다. 이제 프리미엄 혜택을 받으시면서 다크에덴을 더욱 재미있게 즐기실 수 있게 되었습니다.\n\n이번 이벤트에 대한 보너스 혜택으로 다덴마켓에서 판매하고 있는 열랩세트를 선물로 드리고 있습니다.\n\n(단, 이벤트 아이템은 한 계정당 한 캐릭터에 한해서만 받을 수 있습니다.)\n아이템 지급은 최초 접속한 캐릭터에게 지급되니 캐릭터 접속에 차질 없으시기 바랍니다.\n\n*이벤트NPC\n\n슬레이어: 크리스틴 (성직자길드1층)\n\n뱀파이어: 쎄쓰 (림보성내부)\n\n아우스터즈: 호라 (아우스터즈 마을내부)\n\n그럼 열랩세트 아이템을 입고 다크에덴을 200% 즐겨보세요.\n\n";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILDMASTER_NOTDELETE] = "길드 마스터는 캐릭터 삭제를 할 수 없다." ;
	(*g_pGameStringTable)[UI_STRING_MESSAGE_RE_INPUT_CORRECT_DELETE] = "delete를 정확히 입력해주세요." ;

	(*g_pGameStringTable)[STRING_ERROR_INVALID_DELETE] = "입력이 잘못되었습니다."; 

	(*g_pGameStringTable)[STRING_MESSAGE_WARMING_LOGIN1] = "장시간의 게임 이용은 건강을 해칠 수 있습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_WARMING_LOGIN2] = "공부와 일에 휴식이 필요하듯이, 게임이용에도 적절한 휴식이 필요 합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_WARMING_1HOUROVER] = "%d시간이 경과하였습니다." ;
	(*g_pGameStringTable)[STRING_MESSAGE_WARMING_3HOUROVER] = "%d시간이 경과했습니다. 잠시 쉬었다 하시기 바랍니다.";
	

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_FLAME_COLOR] = "색상이 중복하여 염색이 불가합니니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_MONEY_FKANE_COLOR] = "돈이 부족하여 염색할수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FKANE_COLOR_OK] = "염색이 완료되었습니다.";


	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_HOPE_COUPLE_MSG] = "영의 결속은 두사람의 합의 하에 이루어져야 합니다.\n신청 방법은, 결속을 이루길 원하는 원하는 상대의 이름을 입력한 후 신청 받은 사람이 1분 안에 저에게 와서 동의 하시면, 커플이 성립됩니다. 이 사항들을 기억하십시오.\n그럼, 영의 결속을 이루길 원하시는 분의 이름을 입력하여 주십시오.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_BREAK_UP_COUPLE_MSG] = "결속을 파기하길 원하실 경우, 두가지 방법이 있습니다.\n서로의 합의 하에 이루어지는 파기와 , 합의 없이 이루어지는 일방적인 파기가 있습니다. \n단, 일방적인 결속의 파기를 선택하실경우 , 자신의 성향이 감소한다는 것을 기억하십시오" ;

	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_FORCE_BREAK_UP_COUPLE] = "결속을 파기하길 원하실 경우, 두가지 방법이 있습니다.\n서로의 합의 하에 이루어지는 파기와 , 합의 없이 이루어지는 일방적인 파기가 있습니다. \n단, 일방적인 결속의 파기를 선택하실경우 , 자신의 성향이 감소한다는 것을 기억하십시오" ;
	
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_EVENT_TERM] = "영의 결속 이벤트 기간이 아닙니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_ALREADY_WAITING] = "이미 상대를 기다리고 있습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_LOGOFF] = "상대방이 로그인 하지 않았습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_DIFFERENT_RACE] = "서로 다른 종족입니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_SAME_SEX] = "남녀 사이에만 커플이 성립됩니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_PAY_PLAYER] = "유료 사용자가 아닙니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_ALREADY_COUPLE] = "이미 영의 결속 상태입니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_WAS_COUPLE] = "영의 결속을 맺은 적이 있습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_ENOUGH_GOLD] = "소지금이 부족합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_ENOUGH_ATTR] = "능력치가 부족합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_ENOUGH_LEVEL] = "레벨이 부족합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_INVENTORY_FULL] = "결속의 팬던트을 받을 공간이 부족합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NO_WAITING] = "당신을 기다리는 상대방이 없습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_NOT_COUPLE] = "영의 결속이 아닙니다.";

	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_MEET_SUCCESS] = "영의 결속이 성사되었습니다. 인벤토리에 결속의 팬던트아이템이 추가되었습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_CANNOT_MEET] = "영의 결속이 성사될 수 없습니다.";


	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE] = "영의 결속";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_MOVE_START] = "영의 결속 캐릭터를 찾고 있습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS_COUPLE_CAN_NOT_FIND] = "영의 결속 캐릭터를 찾을 수 없습니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USE_ITEM] = "아이템을 사용하시겠습니까?" ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_IS_USED_ITEM] = "동일한 아이템이 이미 사용 중 입니다." ; 


	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_EXCHANGE_OF_MONEY] = "소지금이 부족하여 교환이 불가능합니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_PLAYER_MONEY] = "소지금이 넘어 교환할수 없습니다." ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_CHECK_MONEY] = "교환가능한 아이템이 없습니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EXCHANGE_OF_MONEY_OK] = "교환이 정상적으로 이루어졌습니다." ; 
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_USER] = "잘못된 대상입니다." ; 	

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_SOCCER_BALL] = "축구공이 부족해 상품으로 교환할수 없습니다." ; 	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NPC_NOT_ENOUGH_EXCHANGE_SEALING_STONE] = "봉인석을 만들기위한 아이템이 부족합니다." ; 	
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_800x600] = "800×600" ; 	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_1024x768] = "1024×768" ; 	

	(*g_pGameStringTable)[UI_STRING_MESSAGE_DEFERRED_PAYMENT_NOTICE] = "후불제 계정입니다." ; 	


	(*g_pGameStringTable)[UI_STRING_MESSAGE_SELECT_TAXRATE] = "세율을 결정할수 있습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_TAXRATE_PERSENT] = "%d%%";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER] = "%s 운영권한이 %s님에게 승계됩니다. %s에게 권한 이임 하시겠습니까?" ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER_DESC] = "권한을 이임합니다." ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER_ERROR_1] = "권한을 이임할 수 없는 캐릭터입니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER_ERROR_2] = "길드 마스터 변경은 일주일에 한번 가능합니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER_ERROR_3] = "공성전 신청 중에는 길드 마스터를 변경할 수 없습니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DELEGATION_OF_POWER_ERROR_4] = "권한 이임이 중지되었습니다." ; 
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SIEGE_WAR_CHALLENGE_ERROR_1] = "길드 마스터의 레벨이 130레벨 이하인 경우 공성전을 신청할 수 없습니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SIEGE_WAR_CHALLENGE_ERROR_2] = "20명 이하의 길드는 공성전을 신청할 수 없습니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SIEGE_WAR_CHALLENGE_ERROR_3] = "길드원 평균레벨이 60레벨 미만인 경우 공성전을 신청할 수 없습니다." ; 
	
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_RED]					= "STR +%d";
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_GREEN]					= "DEX +%d";
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_BLUE]					= "INT +%d";
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_BLACK]					= "회피율 +%d";

	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_REWARD_ALL_STAT]		= "모든 능력치 +%d" ; 
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_REWARD_MP]				= "MP +%d" ; 
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_REWARD_ACCURACY]		= "명중률 +%d" ; 
	(*g_pGameStringTable)[UI_STRING_CUE_OF_ADAM_REWARD_DAMAGE]			= "데미지 +%d" ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENTER_SURVIVAL_ZONE]	= "지금은 입장 할 수 없습니다." ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_GIVE_GAMBLE_ITEM]			= "누적점수 %u에 해당하는 아이템을 받았습니다." ; 
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GAMBLE_ACCUMULATION_INIT]	= "누적점수를 초기화하였습니다." ; 

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_EVENT_ITEM]		= "교환에 필요한 이벤트 아이템이 부족합니다." ; 

	(*g_pGameStringTable)[UI_STRING_LEARN_SKILL_LEVEL_FOR_STRING]		= "스킬 배움 레벨 : %s";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_LEARN_SKILL_ACVAMPIRE]		= "%s 스킬을 선택하셨습니다. 이후부터는 %s 스킬만 배우실 수 있습니다. 이대로 계속하시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_LEARN_SKILL_ACVAMPIRE_2]	= "\"%s\"님은 %s을 선택하셨습니다. 한번 결정한 계열은 더 이상 수정이 불가능합니다. 이대로 괜찮습니까?";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACVAMPIRE_WARRIOR_TYPE]		= "전사계열";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACVAMPIRE_MAGICIAN_TYPE]	= "법사계열";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_WORLD_MAP]					= "전체 지도(World Map)";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_ENOUGH_ITEM]			= "교환에 필요한 아이템이 부족합니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TITLE_HOTKEY_CONNECT]		= "Connect";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TITLE_HOTKEY_OPTION]		= "Option";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TITLE_HOTKEY_CREDIT]		= "Credit";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TITLE_HOTKEY_EXIT]			= "Exit";

	(*g_pGameStringTable)[STRING_MESSAGE_FORCE_ATTACK_ENABLE]			= "강제 공격이 설정되었습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_FORCE_ATTACK_DISABLE]			= "강제 공격이 해제되었습니다.";
	
	(*g_pGameStringTable)[STRING_MESSAGE_BACKGROUNDSOUND_ENABLE]		= "배경음이 켜졌습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_BACKGROUNDSOUND_DISABLE]		= "배경음이 꺼졌습니다.";

	(*g_pGameStringTable)[STRING_MESSAGE_EFFECTSOUND_ENABLE]			= "효과음이 켜졌습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_EFFECTSOUND_DISABLE]			= "효과음이 꺼졌습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_USE_RESURRECT_SKILL_FROM_OTHER] = "다른 플레이어의 도움을 받아 부활합니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PAYMENT_FREE]				= "무료";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PAYMENT_PREMIUM]			= "유료";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASK_DIALOG_LOWINITSTATUS]	= "%s 포인트 %d가 보너스 포인트 %d로 환원됩니다, 아이템을 사용하시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANNOTUSE_INITSTATUS]		= "더 이상 망각의 수정을 사용할 수 없습니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADEDISPLAY_BLACK]		= "다크에덴 블랙 버전은 게임산업진흥에 관한 법률 제 21조에 의해 18세 이상 이용가로 분류된 게임입니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADEDISPLAY_WHITE]		= "다크에덴 화이트 버전은 게임산업진흥에 관한 법률 제 21조에 의해 12세 이상 이용가로 분류된 게임입니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANNOT_PLAY_UNDER_15]		= "15세 미만은 접속 할 수 없는 서버입니다.";

	(*g_pGameStringTable)[UI_STRING_CANNOT_DISPLAY_PERSNALSHOP]			= "개인 상점에 등록할 수 없습니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TITLE_HOTKEY_NEWID]			= "NewID";
	
	(*g_pGameStringTable)[STRING_MESSAGE_EXIT_QUESTION]					= "종료 하시겠습니까?";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_DENY_ATTEND]				= "신규 가입 회원만 이벤트에 참여 가능 합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TODAY_NOT_ATTEND]			= "이미 출석 하셨습니다. 내일 다시 참여해 주세요.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHECK_COUNT_ATTEND]			= "%s님은 %d번 출석하셨습니다.";

	(*g_pGameStringTable)[UI_STRING_PET_EFFECT_NO_CAPSULE]				= "캡슐 능력 없음";
	(*g_pGameStringTable)[UI_STRING_PET_EFFECT_SHOCK_CAPSULE]			= "쇼크 능력 있음";
	(*g_pGameStringTable)[UI_STRING_PET_EFFECT_ICE_CAPSULE]				= "아이스 능력 있음";
	(*g_pGameStringTable)[UI_STRING_PET_EFFECT_DIET_CAPSULE]			= "다이어트 능력 있음";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_ENCHANT_LEVEL_FAIL]		= "펫의 레벨 조건이 맞지 않아 인챈트 할 수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENCHANT_DUPLICATE_FAIL]		= "인챈트 효과가 중복되어 사용할 수 없습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_ENCHANT_OK]				= "펫 인첸트가 성공하였습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADE_18]				= "청소년은 이용할 수 없는 게임입니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADE_12]				= "12세미만은 이용할 수 없는 게임입니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADE]					= "이용등급확인";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NEED_USE_AGREEMENT]			= "Game use is only available to users who agree to the \"Darkeden Use Agreement\". \n"
																		  "This can be done by clicking the \"Darkeden Use Agreement\" \n"
																		  "button located at Darkeden homepage.";
	//20071116 - 스피드핵 페널티 에러메세지 추가.
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SPEED_HACK_PENALTY_USER]	= "Illegal program detected. You can not log in game server for an hour.";

	(*g_pGameStringTable)[STRING_MESSAGE_CANNOT_ENCHANT_FROM_LEVEL]		= "You can enchant wearable items only.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASK_DIALOG_USE_SKILL_BOOK]	= "선택하신 레어스킬을 배우시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_RARE_SKILL_INFO_WINDOW]	= "레어 스킬창을 봅니다.";
	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_MELEE]		= "유니크 옵션 이하 공격 무기 아이템에 인챈트 사용 가능 합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_MAGIC]		= "유니크 옵션 이하 공격 마법 아이템에 인챈트 사용 가능 합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_ARMOR]		= "유니크 옵션 이하 공격 방어구 아이템에 인챈트 사용 가능 합니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_OK]			="인챈트에 성공 하였습니다.아이템에 새로운 옵션이 생성되었습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_FAIL]			="인챈트에 실패 하였습니다.인챈트 옵션이 사라졌습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_DOWN_GRADE]	="인챈트에 실패 하였습니다.아이템의 급수가 한 단계 하락 하였습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_THIRD_OPTION]			="인챈트 옵션 : ";
	(*g_pGameStringTable)[STRING_MESSAGE_SKILL_CANNOT_LEARN_BY_STATUS]	= "능력치가 부족해 스킬을 배울 수 없습니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_SKILL_CANNOT_LEARN_BY_LEVEL]	= "해당 레벨이 부족해 스킬을 배울 수 없습니다.";

	
//#if __CONTENTS(__GPS_ADD)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GPS_VIEW]					= "GPS창을 출력 합니다.";
//#endif

#if __CONTENTS(__CONTRIBUTE_SYSTEM)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRUN]						= "그룬";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_KAHN]						= "칸";	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GABRI]						= "가브리";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PHANTOM]					= "팬텀";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_LED]						= "레드";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_AUGE]						= "오제";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_RENT_BLOOD_BIBLE3]			= "%s %s의 징표를 빌립니다. (%s %s)";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_ARMEGA]="회피율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_ARMEGA]="회피율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_ARMEGA]="회피율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_ARMEGA]="회피율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_ARMEGA]="회피율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_ARMEGA]="회피율+7";


	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_MIHOLE]="모든능력치+1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_MIHOLE]="모든능력치+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_MIHOLE]="모든능력치+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_MIHOLE]="모든능력치+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_MIHOLE]="모든능력치+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_MIHOLE]="모든능력치+6";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_KIRO]="방어율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_KIRO]="방어율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_KIRO]="방어율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_KIRO]="방어율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_KIRO]="방어율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_KIRO]="방어율+7";


	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_INI]="회피율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_INI]="회피율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_INI]="회피율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_INI]="회피율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_INI]="회피율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_INI]="회피율+7";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_GREGORI]="방어율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_GREGORI]="방어율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_GREGORI]="방어율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_GREGORI]="방어율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_GREGORI]="방어율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_GREGORI]="방어율+7";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_CONCILIA]="방어율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_CONCILIA]="방어율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_CONCILIA]="방어율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_CONCILIA]="방어율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_CONCILIA]="방어율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_CONCILIA]="방어율+7";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_LEGIOS]="회피율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_LEGIOS]="회피율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_LEGIOS]="회피율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_LEGIOS]="회피율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_LEGIOS]="회피율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_LEGIOS]="회피율+7";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_HILLEL]="모든저항력+1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_HILLEL]="모든저항력+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_HILLEL]="모든저항력+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_HILLEL]="모든저항력+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_HILLEL]="모든저항력+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_HILLEL]="모든저항력+6";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_JAVE]="모든능력치+1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_JAVE]="모든능력치+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_JAVE]="모든능력치+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_JAVE]="모든능력치+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_JAVE]="모든능력치+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_JAVE]="모든능력치+6";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_NEMA]="모든저항력+1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_NEMA]="모든저항력+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_NEMA]="모든저항력+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_NEMA]="모든저항력+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_NEMA]="모든저항력+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_NEMA]="모든저항력+6";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_AROSA]="모든저항력+1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_AROSA]="모든저항력+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_AROSA]="모든저항력+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_AROSA]="모든저항력+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_AROSA]="모든저항력+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_AROSA]="모든저항력+6";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GRUN_CHASPA]="방어율+2";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_KAHN_CHASPA]="방어율+3";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_GABRI_CHASPA]="방어율+4";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_PHANTOM_CHASPA]="방어율+5";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_LED_CHASPA]="방어율+6";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_BONUS_AUGE_CHASPA]="방어율+7";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_CONTRIBUTE]="기여도";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_7]="프린스담즈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_6]="파워즈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_5]="버츄즈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_4]="도미니온즈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_3]="트론즈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_2]="케루빔";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SLAYER_CONTRIBUTENAME_1]="세라핌";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_7]="카임";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_6]="베리알";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_5]="페르제바브";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_4]="아스타로트";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_3]="루키후그";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_2]="마르베스";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_VAMPIRE_CONTRIBUTENAME_1]="루키펠";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_7]="미카일";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_6]="지브릴";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_5]="마로트";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_4]="하루트";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_3]="하루트";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_2]="아즈라엘";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_1]="이스라펠";

#endif //__CONTRIBUTE_SYSTEM
	(*g_pGameStringTable)[UI_STRING_MESSAGE_LEFT_PREMIUM_PAYZONE_DAYS]="유료존 입장권 사용기간이 %d일 남았습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GEAR_CHANGE]="아이템 장착창 교체";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_QUEST_RUN]="퀘스트가 진행중 입니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_PRIMEUM_ADDMIN]="프리미엄 결제 후, 사용 가능합니다.";
	(*g_pGameStringTable)[STRING_MESSAGE_QUITEXIT_AFTER_SECOND] = "%d초 후에 게임을 종료합니다.";
	
//#if __CONTENTS(__TUNING_ITEM)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_CONFIRM1] = "%s 아이템을 사용 할 수 있습니다. %s급 아이템으로 업그레이드(Upgrade) 하시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_CONFIRM2] = "%s 아이템에 사용시 %s급 아이템으로 업그레이드(Upgrade) 할 수 있습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_CONFIRM3] = "%s 아이템을 사용 할 수 있습니다. 다음단계 아이템으로 업그레이드(Upgrade) 하시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_CONFIRM4] = "%s 아이템에 사용시 다음단계 아이템으로 업그레이드(Upgrade) 할 수 있습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_00_NAME] = "호루스(Horus)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_01_NAME] = "세트(Seth)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_02_NAME] = "마아트(Maat)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_03_NAME] = "오시리스(Osiris)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_04_NAME] = "토트(Thoth)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_05_NAME] = "누트(Nut)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_06_NAME] = "게브(Geb)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_07_NAME] = "슈(Shu)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_08_NAME] = "라(Ra)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_09_NAME] = "프타(Ptah)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANTE_10_NAME] = "눈(Nun)";


	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAN_TUNING] = "업그레이드(Upgrade)할 수 있습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING] = "업그레이드(Upgrade)할 수 없습니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING_RACE] = "이 아이템은 %s입니다. 업그레이드(Upgrade)아이템을 사용할 수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING_SPECIAL_ITEM] = "유니크 아이템이나 리미티드 아이템은 업그레이드(Upgrade)할 수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING_ADVANCE_OVER] = "%s 아이템은 %s급 이상 사용 가능합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING_DOMAIN_OVER]	= "%s 아이템은 도메인 총합 %d 이상 사용 가능합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_TUNING_LEVEL_OVER] = "%s 아이템은 레벨 %d 이상 사용 가능합니다.";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_DESCRIPTION] = "%s를 다음단계로 업그레이드 할 수 있습니다. (사용조건: %s급 이상)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_DESCRIPTION_DOMAIN] = "%s를 다음단계로 업그레이드 할 수 있습니다. (사용조건: 도메인 총합 %d 이상)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TUNING_DESCRIPTION_LEVEL] = "%s를 다음단계로 업그레이드 할 수 있습니다. (사용조건: 레벨 %d 이상)";
//#endif //__TUNING_ITEM

	(*g_pGameStringTable)[UI_STRING_GQUEST_DOING_BRACKET] =	"(수행중)";
	(*g_pGameStringTable)[UI_STRING_GQUEST_STANDING_BRACKET] = "(대기중)";
	(*g_pGameStringTable)[UI_STRING_GQUEST_COMPLETION_BRACKET] = "(완료)";

	(*g_pGameStringTable)[UI_STRING_GQUEST_QUEST] = "퀘스트 ";
	(*g_pGameStringTable)[UI_STRING_CONTRIBUTE_GRADE] = "등급";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_ONE_CLICK_ATTACK_OFF] = "원 클릭 공격방식 끄기";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER] = "서버";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS] = "상태정보";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_RACE] = "서버별 종족 정보";

//#if __CONTENTS(__BLITZ_COUPON_EVENT)
	(*g_pGameStringTable)[UI_STRING_BLITZ_COUPON] = "총 문양 누적 개수: %d\n남은 잔여 문양 개수: %d";
	(*g_pGameStringTable)[STRING_MESSAGE_REWORD_ITEM_OK] = "%s를 획득 하였습니다.";
//#endif //__BLITZ_COUPON_EVENT

//#if __CONTENTS(__PREMIUM_GIVE_ITEM_UI)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUEST_PREMIUM_GIVE_ITEM] = "프리미엄 아이템을 지급받습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PREMIUM_GIVE_ITEM_TOOLTIP_GET] = "선택된 프리미엄 아이템을 지급받습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PREMIUM_GIVE_ITEM_TOOLTIP_GET_ALL] = "프리미엄 아이템을 모두 지급받습니다.";
//#endif //__PREMIUM_GIVE_ITEM_UI

	(*g_pGameStringTable)[STRING_ERROR_ITEM_EXCHANGE_ERROR] = "해당 아이템은 더 이상 거래 할수 없습니다.";	//교환에서 더이상 교환 될 수 없는 아이템의 대한 에러 메시지 2008.09.25 shootkj
//#if __CONTENTS(__FUNCTION_PETFOOD)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FUNCTIONPETFOODTYPE_0] = "기능성 먹이 없음";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FUNCTIONPETFOODTYPE_1] = "행운 + 10";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FUNCTIONPETFOODTYPE_2] = "타종언어 번역";
//#endif //__FUNCTION_PETFOOD
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILDNAMEYOK] = "이름에 불건전한 단어가 포함되어 있습니다. 변경해 주세요.";

//#if__TITLE_UI_RENWEAL
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_SERVERSELECT_TEXT1] = "접속할 서버를 선택해 주세요.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_SERVERSELECT_TEXT2] = "각 서버는 독립적으로 운영되지만 캐릭터 및 아이템은 공유되며, 서버간 채팅도 지원 됩니다.";

	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CHARMANAGER_TEXT1] = "플레이할 캐릭터를 선택하세요. 새로운 캐릭터를 생성하려면 캐릭터 생성 버튼을 누르시고";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CHARMANAGER_TEXT2] = "기존의 캐릭터를 삭제 하려면 이름 옆의 삭제 버튼을 누르세요.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CHARMANAGER_TEXT3] = "게임에 접속하시려면 캐릭터를 선택한 후 게임시작 버튼을 누르시면 됩니다.";


	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT1] = "새로운 슬레이어/뱀파이어/아우스터즈를 생성 합니다.";	 //3종족.
	//아우스터즈 봉인.
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT2] = "캐릭터의 이름, 성별, 얼굴, 색상 등을 결정하신 후 재설정 버튼으로 캐릭터의 능력치를 설정하세요.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT3] = "저장하기/불러오기 버튼으로 능력치를 저장하고 불러올 수 있습니다. 뱀파이어의 경우는 머리색과 능력치를 선택 할 수 없습니다.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT4] = "아우스터즈의 경우는 성별과 피부색을 선택 할 수 없고 능력치는 직접 선택하여 올리실 수 있습니다.";

//#endif

//#if __CONTENTS(__GAMEOPTION_ITEMBAY_MESSAGEBOX)
	(*g_pGameStringTable)[UI_GAME_OPTION_ITEM_BAY_MESSAGE_BOX]	= "Item Drop 확인하기";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CONFIRM_ITEM_DROP]	= "정말로 Item을 버리시겠습니까?";
//#endif
//__REPAIRSYSTEM_RENEWAL	
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_DC_PRICE]				= "할인가격 : ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_DC_PRICE_COUNT]		= "수리비를 계산 중 입니다.";
//end __REPAIRSYSTEM_RENEWAL
//#if __CONTENTS(__THIRD_ENCHANT_2)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THIRD_ENCHANT_2_OVERLEVEL]		= "인챈트 단계가 사용조건보다 높아 사용할 수 없습니다.";
//#endif //__THIRD_ENCHANT_2
//#if __CONTENTS(__FUNCTION_PETFOOD_SMART)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FUNCTIONPETFOODTYPE_3]			= "경험치 + 20%";
//#endif //__FUNCTION_PETFOOD_SMART
//스핵 감지 코드 문자열
	(*g_pGameStringTable)[STRING_MESSAGE_LOGOUT_ABUSE_ACTION]			= "비정상적인 게임 방식으로 감지가 되고 있습니다. %d초후 로그 아웃 됩니다.";
//스핵 감지 코드 문자열 끝
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_NOT_PETITEM]			= "펫아이템이 아닙니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_DIE]					= "죽어 있는 펫은 사용 할 수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_LOWLEVEL]				= "펫의 레벨이 너무 낮습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_CANNOTLEVEL]			= "펫이 조합 혹은 재료의 대상이 될 수 없는 레벨입니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_DIDMIX]				= "이미 조합 된 펫입니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_FORGE_OK]				= "펫 조합기를 사용합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_FORGE_CANCEL]			= "펫 조합기 사용을 취소합니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PETMIXING_SUMMONING]			= "소환 중인 펫은 사용 할 수 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_PETMIXING_OPTION]			= "조합 : ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_PETMIXING_FAIL]			= "펫 조합에 실패 하였습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REMOVE_PET_MIXINGOPTION]		= "애완동물의 조합 옵션을 지우시겠습니까?";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_USERGRADEDISPLAY_SAYMAN]		= "심의 등급";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_PALYTIME_DISPLAY]				= "게임 시작 후 %d 시간이 경과하였습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PALYTIME_DISPLAY_ADD]			= "게임 시작 후 %d 시간이 경과하였습니다.잠시 쉬었다 하시기 바랍니다.";

//#if __CONTENTS(__FRIEND_ADDITION)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FRIEND_SYSTEM]					= "친구 시스템";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FRIEND_WAIT]					= "친구 대기창";
//#endif //__FRIEND_ADDITION
	(*g_pGameStringTable)[STRING_ERROR_NO_ADULT]							= "만 18세 미만은 접속할 수 없습니다.";
#if __CONTENTS(__TREASURE_BOX)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OPEN_CASE_FAIL_NOT_ENOUGH_SPACE]= "상자를 여는데 공간이 충분하지 않습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OPEN_CASE_FAIL_NO_ITEM]			= "상자에 아이템이 없습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OPEN_CASE_FAIL_INCORRECT_KEY]	= "상자와 열쇠의 짝이 맞지 않습니다.";
