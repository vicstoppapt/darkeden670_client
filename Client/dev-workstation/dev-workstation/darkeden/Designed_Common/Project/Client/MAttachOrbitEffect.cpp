...
MAttachOrbitEffect::InitOrbitPosition()
{
	...
	const int pixelOrbitWidthHalf[MAX_EFFECT_ORBIT_TYPE]
		= { TILE_X*2, TILE_X, TILE_X/2};
	const int pixelOrbitHeightHalf[MAX_EFFECT_ORBIT_TYPE]
		= { TILE_Y*2, TILE_Y, TILE_Y/2};
