...
MStopZoneSelectableEffectGenerator::Generate( const EFFECTGENERATOR_INFO& egInfo )
{
		...
		&& frameID<=EFFECTSPRITETYPE_unknow_2566)
	{
		...
		{
			if (frameID>=EFFECTSPRITETYPE_unknow_2557
				&& frameID<=EFFECTSPRITETYPE_unknow_2561)
			{
				frameID = EFFECTSPRITETYPE_unknow_2557 + rand()%5;
			}
			else if (frameID>=EFFECTSPRITETYPE_unknow_2552
				&& frameID<=EFFECTSPRITETYPE_unknow_2556)
			{
				frameID = EFFECTSPRITETYPE_unknow_2552 + rand()%5;
			}
			else if (frameID>=EFFECTSPRITETYPE_unknow_2562
				&& frameID<=EFFECTSPRITETYPE_unknow_2566)
			{
				frameID = EFFECTSPRITETYPE_unknow_2562 + rand()%5;
			}
		}
	}
	//-----------------------------------------------------------
