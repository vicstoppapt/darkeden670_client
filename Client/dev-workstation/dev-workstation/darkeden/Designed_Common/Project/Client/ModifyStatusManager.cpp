...
ModifyStatusManager::ModifyStatusManager()
{
	...
	MFunctionManager::SetFunction(MODIFY_ATTACK_BLOOD_BURST_POINT, Function_MODIFY_ATTACK_BLOOD_BURST_POINT);
	MFunctionManager::SetFunction(MODIFY_DEFENSE_BLOOD_BURST_POINT, Function_MODIFY_DEFENSE_BLOOD_BURST_POINT);
	MFunctionManager::SetFunction(MODIFY_PARTY_BLOOD_BURST_POINT, Function_MODIFY_PARTY_BLOOD_BURST_POINT);
	
	MFunctionManager::SetFunction(MODIFY_ADVANCED_SLAYERSTR, Function_MODIFY_ADVANCED_SLAYERSTR);
	MFunctionManager::SetFunction(MODIFY_ADVANCED_SLAYERDEX, Function_MODIFY_ADVANCED_SLAYERDEX);
	MFunctionManager::SetFunction(MODIFY_ADVANCED_SLAYERINT, Function_MODIFY_ADVANCED_SLAYERINT);

#if __CONTENTS(__CONTRIBUTE_SYSTEM)	
	MFunctionManager::SetFunction(MODIFY_CONTRIBUTE_POINT, Function_MODIFY_CONTRIBUTE_POINT);
#endif //__CONTRIBUTE_SYSTEM
	MFunctionManager::SetFunction(MODIFY_DIANJUAN, Function_MODIFY_DIANJUAN); //劤속돨듐얩 뫘劤

	MFunctionManager::SetFunction(MODIFY_JIFEN, Function_MODIFY_JIFEN); //劤속돨생롸 뫘劤

	MFunctionManager::SetFunction(MODIFY_LUCK, Function_MODIFY_LUCK);
	MFunctionManager::SetFunction(MODIFY_HPSTEAL, Function_MODIFY_HPSTEAL);
	MFunctionManager::SetFunction(MODIFY_MPSTEAL, Function_MODIFY_MPSTEAL);
	MFunctionManager::SetFunction(MODIFY_ALLRES, Function_MODIFY_ALLRES);
	MFunctionManager::SetFunction(MODIFY_CRI, Function_MODIFY_CRI);
...
#if __CONTENTS(__GEAR_SWAP_CHANGE)		//ModifyStatusManager::Function_MODIFY_CURRENT_STR	 pGear->CheckAffectStatusAllGear
...
#if __CONTENTS(__GEAR_SWAP_CHANGE)		//ModifyStatusManager::Function_MODIFY_CURRENT_DEX		pGear->CheckAffectStatusAllGear()
	pGear->CheckAffectStatusAllGear();
#else
	pGear->CheckAffectStatusAll();
#endif //__GEAR_SWAP_CHANGE			
...
ModifyStatusManager::Function_MODIFY_LEVEL(void* pVoid)
{
	...
	(*g_pSkillManager)[SKILLDOMAIN_OUSTERS].SetDomainLevel( value );
...
#if __CONTENTS(__GEAR_SWAP_CHANGE)		// ModifyStatusManager::Function_MODIFY_LEVEL	pGear->CheckAffectStatusAllGear()
	pGear->CheckAffectStatusAllGear();
#else
	pGear->CheckAffectStatusAll();
#endif //__GEAR_SWAP_CHANGE			
...
void 
ModifyStatusManager::Function_MODIFY_ATTACK_BLOOD_BURST_POINT(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;

	g_char_slot_ingame.AttackBloodBurstPoint = value;

	gC_vs_ui.SetBloodBurstAttackGage();
}

void 
ModifyStatusManager::Function_MODIFY_DEFENSE_BLOOD_BURST_POINT(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid ) 
	if(g_pPlayer == NULL)
		return;

	g_char_slot_ingame.DefenseBloodBurstPoint = value;
	gC_vs_ui.SetBloodBurstDefenseGage();
}


void 
ModifyStatusManager::Function_MODIFY_PARTY_BLOOD_BURST_POINT(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;

	g_char_slot_ingame.PartyBloodBurstPoint = value;
	gC_vs_ui.SetBloodBurstPartyGage();
}

void
ModifyStatusManager::Function_MODIFY_ADVANCED_SLAYERSTR(void *pVoid)
{
	
	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;
	g_char_slot_ingame.SlayerAdvancedStr = value;

}


void
ModifyStatusManager::Function_MODIFY_ADVANCED_SLAYERDEX(void *pVoid)
{
	
	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;
	g_char_slot_ingame.SlayerAdvancedDex = value;

}

void
ModifyStatusManager::Function_MODIFY_ADVANCED_SLAYERINT(void *pVoid)
{

	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;
	g_char_slot_ingame.SlayerAdvancedInt = value;

}

#if __CONTENTS(__CONTRIBUTE_SYSTEM)
void
ModifyStatusManager::Function_MODIFY_CONTRIBUTE_POINT(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )
	if(g_pPlayer == NULL)
		return;
	g_char_slot_ingame.ContributePoint = value;

}
#endif //__CONTRIBUTE_SYSTEM

void
ModifyStatusManager::Function_MODIFY_DIANJUAN(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )
	
	g_pMoneyManager->SetDianJuan( value );
}

void
ModifyStatusManager::Function_MODIFY_JIFEN(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )

		g_pMoneyManager->SetJiFen( value );
}
void
ModifyStatusManager::Function_MODIFY_LUCK(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )
...
void
ModifyStatusManager::Function_MODIFY_HPSTEAL(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )

		UI_SetCharInfoHpSteal( value );

}
void
ModifyStatusManager::Function_MODIFY_MPSTEAL(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )

		UI_SetCharInfoMpSteal( value );

}
void
ModifyStatusManager::Function_MODIFY_ALLRES(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )

		UI_SetCharInfoAllRes( value );

}
void
ModifyStatusManager::Function_MODIFY_CRI(void *pVoid)
{
	EXTRACT_MODIFY_VALUE( pVoid )

		g_char_slot_ingame.cri= value;
