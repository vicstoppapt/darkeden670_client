...
class DRAWTEXT_NODE_HEAP : public DRAWTEXT_NODE
{
public:
	DRAWTEXT_NODE_HEAP(int x, int y, const char* str, COLORREF color=0x00FFFFFF, BYTE font=0, int flag=0)
		: DRAWTEXT_NODE(x, y, NULL, color, font, flag), HeapString(str)
	{
		String = HeapString.GetString();
	}
