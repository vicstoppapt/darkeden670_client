...
class ModifyStatusManager : public MFunctionManager {
	...
	public :
		...
		static void Function_MODIFY_ATTACK_BLOOD_BURST_POINT(void *pVoid);
		static void Function_MODIFY_DEFENSE_BLOOD_BURST_POINT(void *pVoid);
		static void Function_MODIFY_PARTY_BLOOD_BURST_POINT(void *pVoid);
		
		static void Function_MODIFY_ADVANCED_SLAYERSTR(void *pVoid);
		static void Function_MODIFY_ADVANCED_SLAYERDEX(void *pVoid);
		static void Function_MODIFY_ADVANCED_SLAYERINT(void *pVoid);
		
#if __CONTENTS(__CONTRIBUTE_SYSTEM)	
		static void Function_MODIFY_CONTRIBUTE_POINT(void *pVoid);
#endif //__CONTRIBUTE_SYSTEM

		static void Function_MODIFY_DIANJUAN(void *pVoid); //新加的点卷更新
		static void Function_MODIFY_JIFEN(void *pVoid); //新加的点卷更新

		static void Function_MODIFY_LUCK(void *pVoid);
		static void Function_MODIFY_HPSTEAL(void *pVoid);
		static void Function_MODIFY_MPSTEAL(void *pVoid);
		static void Function_MODIFY_ALLRES(void *pVoid);
		static void Function_MODIFY_CRI(void *pVoid);
};
