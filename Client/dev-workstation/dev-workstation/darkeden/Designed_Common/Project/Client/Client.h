...
#define PROGRAM_NAME                "·è¿ñÁ¶Óü"
#else//__IMI_INTERFACE
#define PROGRAM_NAME                "·è¿ñÁ¶Óü"
#endif //__IMI_INTERFACE

#if __CONTENTS(__IMI_INTERFACE)
#define PROGRAM_TITLE                "·è¿ñÁ¶Óü"
#else//__IMI_INTERFACE
#ifdef __DESIGNED_CHS	//by viva
#define PROGRAM_TITLE                "·è¿ñÁ¶Óü"
#else
#define PROGRAM_TITLE                "·è¿ñÁ¶Óü"
#endif
...
#define	PROGRAM_FILENAME			"fk.exe"
#define	UPDATER_FILENAME			"Updater.exe"
#define	UPDATER_NEW_FILENAME		"Updater2.exe"

//(!) RPK_PASSWORD defineÀº VS_UI_filepath.h¿¡µµ ÀÖÀ½
...
#define MAX_EVENTMESSAGE	5
#define MAX_GMMESSAGE		5
#define WorldChatingMessage 5
...
extern CWin32Edite			*g_pWin32Edite;
...
extern DWORD				g_PingSendTime;
extern DWORD				g_PingReceivTime;
extern DWORD				g_Ping;
// Application Time
extern DWORD				gGetApplcationRunTime(bool bReset = false);
...
extern bool					g_bPutMessage;		// È­¸é¿¡ debug¸Þ¼¼Áö¸¦ Ãâ·ÂÇÒ±î?
...
extern CMessageArray*		g_pEventMessage;
extern CInfomationBord*		g_pInfomationBord;
extern CMessageArray*		g_pGMMessage;
//extern CMessageArray*		g_pPlayerMessage;  //Íæ¼ÒÐÅÏ¢Àà
