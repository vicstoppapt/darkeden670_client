...
C_VS_UI_ELEVATOR::C_VS_UI_ELEVATOR()
{
	...
	Set(g_pUserInformation->iResolution_x/2-m_image_spk.GetWidth(ELEVATOR)/2, g_pUserInformation->iResolution_y/2 - m_image_spk.GetHeight(ELEVATOR)/2, m_image_spk.GetWidth(ELEVATOR), m_image_spk.GetHeight(ELEVATOR));
