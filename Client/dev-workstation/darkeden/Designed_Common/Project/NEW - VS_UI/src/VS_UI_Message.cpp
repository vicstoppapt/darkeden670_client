...
// Global
//-----------------------------------------------------------------------------
C_VS_UI_DIALOG *		g_msg_not_available_menu = NULL;
C_VS_UI_DIALOG *		g_msg_wrong_id_password = NULL;
C_VS_UI_DIALOG *		g_msg_invalid_id_password = NULL;
C_VS_UI_DIALOG *		g_msg_wrong_ssn = NULL;
C_VS_UI_DIALOG *		g_msg_wrong_delete = NULL;
C_VS_UI_DIALOG *		g_msg_invalid_ssn = NULL;
C_VS_UI_DIALOG *		g_msg_empty_name = NULL;
C_VS_UI_DIALOG *		g_msg_left_bonus_point = NULL;
//C_VS_UI_DIALOG *		g_msg_server_disconnect;
C_VS_UI_DIALOG *		g_msg_server_connect_failed = NULL;
C_VS_UI_DIALOG *		g_msg_not_select_char = NULL;
C_VS_UI_DIALOG *		g_msg_char_delete_completed = NULL;
C_VS_UI_DIALOG *		g_msg_all_slot_not_char = NULL;
C_VS_UI_DIALOG *		g_msg_all_slot_created = NULL;
C_VS_UI_DIALOG *		g_msg_character_create_failed = NULL;
C_VS_UI_DIALOG *		g_msg_new_user_not_completed = NULL;
C_VS_UI_DIALOG *		g_msg_id_aleady_exist = NULL;
C_VS_UI_DIALOG *		g_msg_id_no_aleady_exist = NULL;
C_VS_UI_DIALOG *		g_msg_password_mismatch = NULL;
...
void g_InitMessage()
{
	...
	g_msg_wrong_id_password = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_invalid_id_password = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_wrong_ssn = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_wrong_delete = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	static char * pp_dmsg_wrong__delete[] ={(*g_pGameStringTable)[STRING_ERROR_INVALID_DELETE].GetString()};
	g_msg_wrong_delete->SetMessage(pp_dmsg_wrong__delete, 1, SMO_NOFIT);

	g_msg_invalid_ssn = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_empty_name = new C_VS_UI_DIALOG(-1, -1, 1, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_left_bonus_point = new C_VS_UI_DIALOG(-1, -1, 1, 0, g_ExecF, DIALOG_TITLE_OK);
...
//	g_msg_server_disconnect->SetMessage(pp_dmsg_server_disconnect, 1, SMO_NOFIT);
	...
	g_msg_server_connect_failed = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_not_select_char = new C_VS_UI_DIALOG(-1, -1, 1, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_char_delete_completed = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_all_slot_not_char = new C_VS_UI_DIALOG(-1, -1, 4, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_all_slot_created = new C_VS_UI_DIALOG(-1, -1, 3, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_character_create_failed = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
...
//	g_msg_character_empty_id->SetMessage(pp_dmsg_character_empty_id, 1, SMO_NOFIT);
	...
	g_msg_id_aleady_exist = new C_VS_UI_DIALOG(-1, -1, 1, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_id_no_aleady_exist = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
	...
	g_msg_password_mismatch = new C_VS_UI_DIALOG(-1, -1, 2, 0, g_ExecF, DIALOG_TITLE_OK);
