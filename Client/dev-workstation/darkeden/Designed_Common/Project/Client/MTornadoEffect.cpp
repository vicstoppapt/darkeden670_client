...
MTornadoEffect::MTornadoEffect(BYTE bltType)
...
//----------------------------------------------------------------------
void
MTornadoEffect::SetTarget(int x, int y, int z, WORD stepPixel)
{
	//--------------------------------------------------
	// 목표 위치 저장
	//--------------------------------------------------
