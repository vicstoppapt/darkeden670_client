...
CIndexSprite::SetColorSet()
{
	...
	*/
	...
	static BYTE rgbPoint[MAX_COLORSET_SEED][3] = 
	{
		...
		// New ColorSet Table 2006.01.24 Sjheon
		{ 31, 20, 15 },
		{ 9, 24, 15 },
		{ 15, 20, 24 },
		{ 31, 31, 24 },
...
{
// 20090120 아래 값이 들어 올때는 기본적으로 의미가 없는 값이다. 하지만 이 값을 토대로 배열 접근 하는 경우가 있어 강종 위험이 있다.
// 따라서 셋값을 0으로 재설정 해준다.
	if(set1 > MAX_COLORSET)
		set1 = 0;
	else if(set2 > MAX_COLORSET)
		set2 = 0;
