...
//-----------------------------------------------------------------------------
// Maximum value설정
#define	MAX_COLORSET_SEED			53 //51 //109 //33	// 기본 색상의 개수
#define	MAX_COLORSET_SEED_MODIFY	15	// 기본 색상마다의 변형 색깔 수
#define	MAX_COLORSET				795 // 765 // 1635 //510 // 495 // MAX_COLORSET_SEED * MAX_COLORSET_SEED_MODIFY
...
class CIndexSprite {
	public :
		...
		virtual bool		LoadFromFile(ivfstream& file) = 0;		
