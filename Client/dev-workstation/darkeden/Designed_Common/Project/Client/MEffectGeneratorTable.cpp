...
MEffectGeneratorTable::Init()
{
	...
	AddEffectGenerator( new MStopZoneRectRandomPixelEffectGenerator );
	AddEffectGenerator( new MAttackCreatureAroundThrowEffectGenerator );
}	
...
{	
		...
		DEBUG_ADD_FORMAT("EGT-Generate. ai=%d, target=0x%X", nActionInfo, pEffectTarget);
			...
			//char szBuf[256];
			//sprintf(szBuf, "EGT-Generate. ai=%d, target=0x%X \n",
			//nActionInfo, pEffectTarget);
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
			//file3.close();
	if (nActionInfo >= g_pActionInfoTable->GetSize())
	{
			...
			//sprintf(szBuf, "Exceed Max ActionInfo(%d/%d)\n",
			//nActionInfo, g_pActionInfoTable->GetSize());
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
			//file3.close();
	...
	if (pEffectTarget==NULL)
	{
			...
			//sprintf(szBuf, "EGT-Generate OK0. ai=%d, target=0x%X\n",
			//nActionInfo, pEffectTarget);
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
	...
	else if ((*g_pActionInfoTable)[ nActionInfo ].GetSize()!=pEffectTarget->GetMaxPhase())
	{
		...
		pEffectTarget = NULL;
			...
			//sprintf(szBuf, "EGT-Generate OK1. ai=%d, target=0x%X\n",
			//nActionInfo, pEffectTarget);
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
		...
		DEBUG_ADD_FORMAT("et=0x%X, targetID=%d, targetPhase=%d", pEffectTarget, (int)pEffectTarget->GetEffectID(), pEffectTarget->GetMaxPhase());
			...
			//sprintf(szBuf, "et=0x%X, targetID=%d, targetPhase=%d\n",
			//pEffectTarget, (int)pEffectTarget->GetEffectID(), pEffectTarget->GetMaxPhase());
			//
			//std::ofstream file4("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file4 << szBuf << std::endl;
			//file4.close();
	//------------------------------------------------------------
	// Effect생성 정보가 없으면...
	...
	//	EffectSpriteType = 3207;
		...
		{
			/*if(info.EffectGeneratorID = 50)
			{
            info.EffectGeneratorID = EFFECTGENERATORID_ATTACK_CREATURE;
			}*/ // test by rallser
			// 목표 완료시킨다.
			//while (!pEffectTarget->IsEnd())
			//{
			...
			//sprintf(szBuf, "[Error] EGT-Generate id=%d, ai=%d, target=0x%X\n",
			//info.EffectGeneratorID, nActionInfo, pEffectTarget);
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
			//file3.close();
		...
		if ( info.EffectSpriteType >= MAX_EFFECTSPRITETYPE )
		{
			if (pEffectTarget->IsExistResult())
			{
				pEffectTarget->GetResult()->Release();				
			...
			#ifdef OUTPUT_DEBUG_EFFECT_GENERATOR
			DEBUG_ADD_FORMAT("[Error] EGT-EffectSpriteType id=%d, ai=%d, target=0x%X", info.EffectSpriteType, nActionInfo, pEffectTarget);
			#endif	

			//sprintf(szBuf, "[Error] EGT-EffectSpriteType id=%d, ai=%d, target=0x%X\n",
			//info.EffectSpriteType, nActionInfo, pEffectTarget);
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
			//file3.close();
		...
		egInfo.temp2				= temp2;
			...
			//sprintf(szBuf, "et=0x%X, targetID=%d, targetPhase2=%d\n",
			//pEffectTarget, (int)pEffectTarget->GetEffectID(), pEffectTarget->GetMaxPhase());
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
		...
		//------------------------------------------------------------
			...
			//sprintf(szBuf, "Generate before. id=%d\n",
			//info.EffectGeneratorID);
			//
			//std::ofstream file5("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file5 << szBuf << std::endl;
			//file5.close();
		...
		if (m_pEffectGenerator[ info.EffectGeneratorID ]->Generate( egInfo ))
		{
			...
			//sprintf(szBuf, "et=0x%X, targetID=%d, targetPhase3=%d\n",
			//pEffectTarget, (int)pEffectTarget->GetEffectID(), pEffectTarget->GetMaxPhase());
			
			//std::ofstream file6("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file6 << szBuf << std::endl;
			//file6.close();
			bGenerated = true;
		}
		else
	...
	{	
		...
		if (pEffectTarget->IsExistResult())
		{
			...
			//sprintf(szBuf, "ExecuteResult. et=0x%X, targetID=%d, targetPhase4=%d\n",
			//pEffectTarget, (int)pEffectTarget->GetEffectID(), pEffectTarget->GetMaxPhase());
			//
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
		...
		!bGenerated || pEffectTarget->IsEnd() )
	{
			...
			//sprintf(szBuf, "Delete EffectTarget!\n");
			//std::ofstream file3("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file3 << szBuf << std::endl;
			//file3.close();
	...
	#endif
			//sprintf(szBuf, "EGT-Generate OK. ai=%d, target=0x%X\n",
			//nActionInfo, pEffectTarget);
			//
			//std::ofstream file7("栗都쇱꿴.log", std::ios::out | std::ios::app);
			//file7 << szBuf << std::endl;
			//file7.close();
}
...
MEffectGeneratorTable::GenerateNext( MEffect* pEffect )
{
	...
	// 2006.04.18
	if( info.EffectGeneratorID == EFFECTGENERATORID_NULL )
		return;
