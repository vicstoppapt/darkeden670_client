...
class MSlayerGear : public MPlayerGear	{
	public :
		...
		//nanomech 2006.03.08 Item수정 작업 (순서 바꿈!!)
		enum GEAR_SLAYER 
		{
			...
			GEAR_SLAYER_ETHEREAL_CHAIN,			// 목걸이 코어잽

			GEAR_SLAYER_CUE1,					// 큐1 - 링에 덛붙이는 아이템
			GEAR_SLAYER_CUE2,					// 큐2
		...
		inline static bool		IsGearSlotCue(MItem* pItem);		///< chyaya 2006.08.18
	...
	protected :
		...
		static const int s_Slot_Offset_Cue;
