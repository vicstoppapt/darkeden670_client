...
const uint szPacketHeader = MSG_HEADER_SIZE;
#else
...
//		PACKET_CG_REQUEST_WEB_MARKET,               // 485
 //       PACKET_GC_SHOW_WEB_MARKET,                  // 486
		...
		PACKET_CL_AGREEMENT,						// 483	넷마블 사용자 약관 동의 패킷

		PACKET_LC_SHOW_WEB_PAGE,					// 484
...
//#endif //__PREMIUM_CARD
		...
		PACKET_GC_INSTANCEDOUNGEON_LOBBY,			// 491
		PACKET_GC_INSTANCEDOUNGEON_RESULT,			// 492
		PACKET_GC_ADD_EFFECT_TO_SCREEN,				// 493	스크린 화면 효과
#endif // __TIPOJYU_CASTLE

#if __CONTENTS(__LC_SELECT_WORLD_ERROR)
		PACKET_LC_SELECT_WORLD_ERROR,				// 494
#endif //__LC_SELECT_WORLD_ERROR
		
#if __CONTENTS(__PREMIUM_GIVE_ITEM_UI)
		PACKET_GC_UPDATE_WEEKITEM_LIST,				// 495
		PACKET_CG_SELECT_WEEKITEM,					// 496
		...
		PACKET_GC_FRIEND_REQ_TO_ADD,				// 501			
		PACKET_GC_FRIEND_SUGGEST_TO_ADD,			// 502
		PACKET_CG_FRIEND_RES_TO_ADD,				// 503
		PACKET_GC_FRIEND_RES_TO_ADD,				// 504
		
		PACKET_CG_FRIEND_REQ_TO_DEL,				// 505
		PACKET_GC_FRIEND_REQ_TO_DEL,				// 506

		PACKET_CG_FRIEND_VIEW_INFO,					// 507
		PACKET_GC_FRIEND_VIEW_INFO,					// 508
		
		PACKET_CG_FRIEND_UPDATE_GLOBAL_OPTION,		// 509
		PACKET_CG_FRIEND_UPDATE_INDIVIDUAL_OPTION,	// 510

		PACKET_GC_FRIEND_LIST,						// 511
		PACKET_GC_FRIEND_WAIT_LIST,					// 512
		
		PACKET_GC_FRIEND_ADD,						// 513
		PACKET_GC_FRIEND_DEL,						// 514
		
		PACKET_GC_FRIEND_UPDATE_CONNECT,			// 515
		PACKET_GC_FRIEND_UPDATE_ZONE,				// 516
		...
		PACKET_GS_LOGIN,							// 517
		PACKET_GS_LOGOUT,							// 518

		PACKET_GS_FRIEND_REQ_TO_ADD,				// 519
		PACKET_SG_FRIEND_REQ_TO_ADD,				// 520
		PACKET_SG_FRIEND_SUGGEST_TO_ADD,			// 521
		PACKET_GS_FRIEND_RES_TO_ADD,				// 522
		PACKET_SG_FRIEND_RES_TO_ADD,				// 523
		
		PACKET_GS_FRIEND_REQ_TO_DEL,				// 524
		
		PACKET_GS_FRIEND_VIEW_INFO,					// 525
		PACKET_SG_FRIEND_VIEW_INFO,					// 526
		
		PACKET_GS_FRIEND_UPDATE_GLOBAL_OPTION,		// 527
		PACKET_GS_FRIEND_UPDATE_INDIVIDUAL_OPTION,	// 528
		
		PACKET_SG_FRIEND_LIST,						// 529
		PACKET_SG_FRIEND_WAIT_LIST,					// 530
		
		PACKET_SG_FRIEND_ADD,						// 531
		PACKET_SG_FRIEND_DEL,						// 532
		
		PACKET_SG_FRIEND_UPDATE_CONNECT,			// 533
		
		PACKET_GS_FRIEND_UPDATE_ZONE,				// 534
		PACKET_SG_FRIEND_UPDATE_ZONE,				// 535

		PACKET_GC_OTHER_GEAR_INFO,
		//
		///////////////////////////////////////////////////////////
#endif //__FRIEND_ADDITION

		PACKET_CG_REQUEST_TMALL_LIST,//537
		PACKET_GC_TMALL_GOODS_LIST,//538

		PACKET_CG_BUY_TMALL_GOODS,

		PACKET_GC_SEND_NEW_WARINFO,

		PACKET_CG_REQUEST_RANK_GEM_DATA,//541
		PACKET_GC_SEND_RANK_GEM_DATA,
		PACKET_CG_USE_RANKGEM_FROM_INVENTORY,//543
		PACKET_CG_REMOVE_RANKGEM,//544
//		PACKET_CG_REQUEST_PING,//545

		PACKET_GC_PAY_EVENT_LIST,//545
		PACKET_CG_REQUEST_PAY_EVENT_LIST,//546
		PACKET_CG_GET_PAYITEM,//547
...
public :
	...
	void writeHeaderNBody (SocketOutputStream& oStream ) const
	{
		...
		PACKETDATA pData;
		pData.m_wMsgSize = getPacketSize();
		pData.m_wMsgType = getPacketID();
		oStream.EncryptHeader(&pData);
