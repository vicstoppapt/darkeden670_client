//////////////////////////////////////////////////////////////////////////////
// Filename    : GCUpdateSupplyItemList.cpp 
// Written By  : rappi76
// Description : 
//////////////////////////////////////////////////////////////////////////////
	 ...
	 throw ( ProtocolException , Error )
{
	...
	if ( totalNum > MAX_SUPPLYITEM_LIST ) throw DisconnectException("GCUpdateSupplyItemList : 물건 개수가 제한을 초과했습니다.");
	 ...
	 throw ( ProtocolException , Error )
{
	...
	GCUpdateSupplyItemListHandler::execute( this , pPlayer );
