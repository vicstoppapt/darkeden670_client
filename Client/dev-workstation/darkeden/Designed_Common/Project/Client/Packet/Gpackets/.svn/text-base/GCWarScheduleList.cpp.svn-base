       ...
       throw ()
{
	...
	for( ; itr != m_WarScheduleList.end(); itr++ )
	{
		...
		if( (*itr)->warType == 0 )
		{
			msg << ", Challenger GuildID 0 : " << (*itr)->challengerGuildID[0];
			msg << ", Challenger GuildID 1 : " << (*itr)->challengerGuildID[1];
			msg << ", Challenger GuildID 2 : " << (*itr)->challengerGuildID[2];
			msg << ", Challenger GuildID 3 : " << (*itr)->challengerGuildID[3];
			msg << ", Challenger GuildID 4 : " << (*itr)->challengerGuildID[4];

			msg << ", Challenger GuildName 0 : " << (*itr)->challengerGuildName[0];
			msg << ", Challenger GuildName 0 : " << (*itr)->challengerGuildName[1];
			msg << ", Challenger GuildName 0 : " << (*itr)->challengerGuildName[2];
			msg << ", Challenger GuildName 0 : " << (*itr)->challengerGuildName[3];
			msg << ", Challenger GuildName 0 : " << (*itr)->challengerGuildName[4];
		}
