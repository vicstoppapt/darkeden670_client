...
//		UI_CloseBloodBibleStatus();
	...
	case NOTICE_EVENT_NOT_ENOUGH_DIANJUAN:
		UI_PopupStrMessage("듐얩꼇璃,헝념令");
		break;

	case NOTICE_EVENT_NOT_ENOUGH_JIFEN:
		UI_PopupStrMessage("생롸꼇璃,헝념令");
		break;

	case NOTICE_EVENT_TMALL_BUY_OK:
		UI_PopupStrMessage("뭔찜냥묘，헝돕뭔膠났瓊혤膠틔.");
		break;
	...
	case NOTICE_EVENT_LOGIN_JUST_NOW:
		// 2009.08.27 neclipse 현재 사용되지 않는 시스템 문구...임시로 막아둔다...고칠것...
