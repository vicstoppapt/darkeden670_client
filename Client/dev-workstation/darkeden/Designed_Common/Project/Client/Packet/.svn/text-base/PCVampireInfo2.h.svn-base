...
public:
	...
	void setMasterEffectColor (WORD mastercolor) throw () { m_MasterEffectColor = mastercolor; }
	...
	Gold_t getDianJuan () const throw () { return m_DianJuan; }
	void setDianJuan (Gold_t gold) throw () { m_DianJuan = gold; }

	//생롸
	Gold_t getJiFen () const throw () { return m_JiFen; }
	void setJiFen (Gold_t jifen) throw () { m_JiFen = jifen; }
