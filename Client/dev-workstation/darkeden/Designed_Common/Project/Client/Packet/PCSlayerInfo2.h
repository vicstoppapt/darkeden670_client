...
public :
	...
	WORD getMasterEffectColor () const throw () { return m_MasterEffectColor; }
	void setMasterEffectColor (WORD masterEffectColor) throw () { m_MasterEffectColor = masterEffectColor; }
	...
	Attr_t getSlayerAdvancedStr() const { return m_SlayerAdvancedStr; }
	void setSlayerAdvancedStr( Attr_t SlayerAdvancedStr ) { m_SlayerAdvancedStr = SlayerAdvancedStr; }
	
	Attr_t getSlayerAdvancedDex() const { return m_SlayerAdvancedDex; }
	void setSlayerAdvancedDex( Attr_t SlayerAdvancedDex ) { m_SlayerAdvancedDex = SlayerAdvancedDex; }
	
	Attr_t getSlayerAdvancedInt() const { return m_SlayerAdvancedInt; }
	void setSlayerAdvancedInt( Attr_t SlayerAdvancedInt ) { m_SlayerAdvancedInt = SlayerAdvancedInt; }
...
#endif //__CONTRIBUTE_SYSTEM
#if __CONTENTS(__ATTACK_SPEED)
	BYTE getAttackSpeed() { return m_AttackSpeed; }
	void setAttackSpeed(int attackSpeedpoint) { m_AttackSpeed = attackSpeedpoint; }
#endif //__ATTACK_SPEED

	Gold_t getDianJuan( ) { return m_DianJuan; }
	void setDianJuan(Gold_t dianjuan)	{ m_DianJuan = dianjuan; }

	Gold_t getJiFen( ) { return m_JiFen; }
	void setJiFen(Gold_t jifen)	{ m_JiFen = jifen; }
...
private:
	...
	Attr_t	m_SlayerAdvancedStr;
	Attr_t	m_SlayerAdvancedDex;
	Attr_t	m_SlayerAdvancedInt;
