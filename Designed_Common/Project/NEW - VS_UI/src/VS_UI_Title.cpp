...
//		m_pC_image_spk = new C_SPRITE_PACK(SPK_CHAR_DELETE);
	...
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+ok_offset_x, y+ok_offset_y, gpC_global_resource->m_pC_assemble_box_button_spk->GetWidth(C_GLOBAL_RESOURCE::AB_BUTTON_OK), gpC_global_resource->m_pC_assemble_box_button_spk->GetHeight(C_GLOBAL_RESOURCE::AB_BUTTON_OK), DELETE_OK, this, C_GLOBAL_RESOURCE::BUTTON_OK_TITLE));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+cancel_offset_x, y+cancel_offset_y, gpC_global_resource->m_pC_assemble_box_button_spk->GetWidth(C_GLOBAL_RESOURCE::AB_BUTTON_OK), gpC_global_resource->m_pC_assemble_box_button_spk->GetHeight(C_GLOBAL_RESOURCE::AB_BUTTON_OK), DELETE_CANCEL, this, C_GLOBAL_RESOURCE::BUTTON_CANCEL_TITLE));
		...
		case DELETE_OK:
			// 넷마블용
			{
				...
				if (
					...
					(strcmp((const char*)m_lev_ssn_part1.GetString(), "delete") == 0)
#else
					((gC_ci->IsKorean() && (m_lev_ssn_part1.Size() == SSN_PART1_CHAR_COUNT &&
						m_lev_ssn_part2.Size() == SSN_PART2_CHAR_COUNT)) ||
						(!gC_ci->IsKorean() && (strcmp((const char*)m_lev_ssn_part1.GetString(), "yes") == 0)))
#endif	//__CHAR_DELETE
					 )
...
//	Set(0, 0, RESOLUTION_X, RESOLUTION_Y );
//#else
//	Set(0, 0, 800, 600 );
//#endif
	// set button
...
//#ifdef CONVERT_1024_768// 새로운 ui가 나왔을때 아래의 임시코드 삭제 요망.
//	int convx = 112 , convy = 84;
//#else
//	int convx = 0 , convy = 0;
//#endif
	//back, next
	int skinnum=0;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,	m_common_spk.GetWidth(BACK_BUTTON), m_common_spk.GetHeight(BACK_BUTTON), BACK_ID, this, BACK_BUTTON)); skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,	m_common_spk.GetWidth(NEXT_BUTTON), m_common_spk.GetHeight(NEXT_BUTTON), NEXT_ID, this, NEXT_BUTTON));skinnum++;

	//face back, next
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(FACE_BACK_BUTTON), m_image_spk.GetHeight(FACE_BACK_BUTTON), FACE_BACK_ID, this, FACE_BACK_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(FACE_NEXT_BUTTON), m_image_spk.GetHeight(FACE_NEXT_BUTTON), FACE_NEXT_ID, this, FACE_NEXT_BUTTON));skinnum++;

	//slayer, vampire
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(SLAYER_BUTTON)+20, m_image_spk.GetHeight(SLAYER_BUTTON), SLAYER_ID, this, SLAYER_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(VAMPIRE_BUTTON)+20, m_image_spk.GetHeight(VAMPIRE_BUTTON), VAMPIRE_ID, this, VAMPIRE_BUTTON));skinnum++;
...
//#endif
	//male, female
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(MALE_BUTTON)+20, m_image_spk.GetHeight(MALE_BUTTON), MALE_ID, this, MALE_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(FEMALE_BUTTON)+20, m_image_spk.GetHeight(FEMALE_BUTTON), FEMALE_ID, this, FEMALE_BUTTON));skinnum++;

	//save,load,reroll
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(SAVE_BUTTON), m_image_spk.GetHeight(SAVE_BUTTON), SAVE_ID, this, SAVE_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(LOAD_BUTTON), m_image_spk.GetHeight(LOAD_BUTTON), LOAD_ID, this, LOAD_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(REROLL_BUTTON), m_image_spk.GetHeight(REROLL_BUTTON), REROLL_ID, this, REROLL_BUTTON));skinnum++;

	//check button
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(CHECK_BUTTON), m_image_spk.GetHeight(CHECK_BUTTON), CHECK_ID, this, CHECK_BUTTON));skinnum++;

	//아우스터즈 +, - 버튼
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(PLUS_BUTTON), m_image_spk.GetHeight(PLUS_BUTTON), STR_PLUS_ID, this, PLUS_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(MINUS_BUTTON), m_image_spk.GetHeight(MINUS_BUTTON), STR_MINUS_ID, this, MINUS_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(PLUS_BUTTON), m_image_spk.GetHeight(PLUS_BUTTON), DEX_PLUS_ID, this, PLUS_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(MINUS_BUTTON), m_image_spk.GetHeight(MINUS_BUTTON), DEX_MINUS_ID, this, MINUS_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(PLUS_BUTTON), m_image_spk.GetHeight(PLUS_BUTTON), INT_PLUS_ID, this, PLUS_BUTTON));skinnum++;
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(pSkin->GetPoint( skinnum ).x+convx,convy+pSkin->GetPoint( skinnum ).y,m_image_spk.GetWidth(MINUS_BUTTON), m_image_spk.GetHeight(MINUS_BUTTON), INT_MINUS_ID, this, MINUS_BUTTON));skinnum++;
...
/*#ifdef CONVERT_1024_768
	SetDesc(29+112, 160+84, RGB(160, 160, 160), gpC_base->m_chatting_pi);
#else*/
...
bool C_VS_UI_NEWCHAR::ChangeColor(int _x, int _y)
{
	...
	for (int j=0; j < COLOR_LIST_Y; j++)
		for (int i=0; i < COLOR_LIST_X; i++)
		{
			...
			if (_x >= TABLE_X2+i*COLOR_UNIT_X +convx && _x < TABLE_X2+i*COLOR_UNIT_X+COLOR_UNIT_X +convx &&
				_y >= TABLE_Y+j*COLOR_UNIT_Y +convy && _y < TABLE_Y+j*COLOR_UNIT_Y+COLOR_UNIT_Y + convy)
				{
			...
			if (_x >= TABLE_X+i*COLOR_UNIT_X +convx && _x < TABLE_X+i*COLOR_UNIT_X+COLOR_UNIT_X +convx &&
				_y >= TABLE_Y+j*COLOR_UNIT_Y +convy && _y < TABLE_Y+j*COLOR_UNIT_Y+COLOR_UNIT_Y +convy)	
				{			
...
/*#ifdef CONVERT_1024_768
			if (_x >= TABLE_X+i*COLOR_UNIT_X +112 && _x < TABLE_X+i*COLOR_UNIT_X+COLOR_UNIT_X +112 &&
				 _y >= TABLE_Y2+j*COLOR_UNIT_Y +84 && _y < TABLE_Y2+j*COLOR_UNIT_Y+COLOR_UNIT_Y + 84)
#else
...
#ifdef CONVERT_1024_768
			if (_x >= TABLE_X+i*COLOR_UNIT_X +112 && _x < TABLE_X+i*COLOR_UNIT_X+COLOR_UNIT_X +112 &&
				 _y >= TABLE_Y+j*COLOR_UNIT_Y +84 && _y < TABLE_Y+j*COLOR_UNIT_Y+COLOR_UNIT_Y +84)			
#else
			if (_x >= TABLE_X+i*COLOR_UNIT_X && _x < TABLE_X+i*COLOR_UNIT_X+COLOR_UNIT_X &&
...
//			if(p_button->GetID() == FACE_BACK_BUTTON || p_button->GetID() == FACE_NEXT_BUTTON)
//			{
		...
		case M_MOVING:
			m_focused_help = HELP_DEFAULT;
			{
				for(int i = 0; i < HELP_MAX; i++)
				{
					...
					if(_x > rect[i].left+convx && _x < rect[i].right+convx && _y > rect[i].top+convy && _y < rect[i].bottom+convy)
						{
							m_focused_help = i;
							break;
...
/*#ifdef CONVERT_1024_768
					if(_x > rect[i].left+112 && _x < rect[i].right+112 && _y > rect[i].top+84 && _y < rect[i].bottom+84)
#else
...
//#ifdef CONVERT_1024_768 //convx,convy 이후코드는 임시코드 추가한거임. ui변경시 삭제 요망
//	int convx = 112, convy = 84;
//#else
//	int convx = 0 , convy = 0;
//#endif
	...
	{
		if(bHighResolution)
			m_title_spk.BltLocked(0, 0);

		m_common_spk.BltLocked(
			(g_pUserInformation->iResolution_x - m_common_spk.GetWidth()) / 2,
			(g_pUserInformation->iResolution_y - m_common_spk.GetHeight()) / 2);
		...
		m_common_spk.BltLockedAlpha(239+convx, 21+convy, LEFT_ANIMATION_TITLE, m_aniArpha);
		m_common_spk.BltLockedAlpha(450+convx, 21+convy, RIGHT_ANIMATION_TITLE, m_aniArpha);
		
//#ifdef CONVERT_1024_768
//		m_common_spk.BltLocked(RESOLUTION_X/2 - m_common_spk.GetWidth()/2 , RESOLUTION_Y/2 - m_common_spk.GetHeight()/2 );
//#else
...
//#endif
		...
		case RACE_SLAYER:
			if(m_p_slot->bl_female)
				m_face_spk.BltLocked(456+convx, convy+219, m_p_slot->man_info.hair-M_HAIR1+GENDER_OFFSET);
			else
				m_face_spk.BltLocked(456+convx, convy+219, m_p_slot->man_info.hair-M_HAIR1);
			//20070627 얼굴 선택 버튼
			m_image_spk.BltLocked(455+convx, 345+convy, FACE_BACK_BUTTON);
			m_image_spk.BltLocked(554+convx, 345+convy,FACE_NEXT_BUTTON);
			break;

		case RACE_VAMPIRE:
			if(m_p_slot->bl_female)
				m_face_spk.BltLocked(456+convx, convy+219, 7);
			else
				m_face_spk.BltLocked(456+convx, convy+219, 6);
			break;

		case RACE_OUSTERS:
			m_face_spk.BltLocked(456+convx, convy+219, 8);
			break;			
		}		
//#if __CONTENTS(__RACE_OUSTERS)		
		m_image_spk.BltLocked(g_heart_rect[0]+convx, 141+convy);
//#else	
//		m_image_spk.BltLocked(g_heart_rect[0]+convx, 141+convy,INTERNATIONAL_TITLE);
//#endif

		m_image_spk.BltLocked(TITLE_X - m_image_spk.GetWidth(TITLE)/2+convx, convy+TITLE_Y, TITLE);
		m_image_spk.BltLocked(618+convx, 141+convy, ABILITY_DISPLAY_TOOL);
		//Fillrect를 이용하기 위해 Unlock
		gpC_base->m_p_DDSurface_back->Unlock();
		RECT rect = {68+convx, convy+355, 171, 475};
		gpC_base->m_p_DDSurface_back->FillRect(&rect, 0);
		if(m_p_slot->Race == RACE_OUSTERS)
		{
			SetRect(&rect, 667+convx, convy+470, 723, 490);
			gpC_base->m_p_DDSurface_back->FillRect(&rect, 0);
		}
		...
		if(m_p_slot->Race == RACE_OUSTERS)
		{
			m_image_spk.BltLocked(645+convx, convy+169, BONUS_LINE);
		}
		// 스킨 컬러
		if(m_p_slot->Race != RACE_OUSTERS)
		{
			m_image_spk.BltLocked(455+convx, convy+385, SKIN_COLOR_SELECT);
		}

		//헤어 컬러
		if(m_p_slot->Race != RACE_VAMPIRE)
		{
			m_image_spk.BltLocked(281+convx, convy+385, HAIR_COLOR_SELECT);
		}
#if	__CONTENTS(__USER_GRADE)	
		int drowx = RESOLUTION_X;
		int drowy = 0;

		if(m_pC_use_grade!=NULL && !g_pUserInformation->bChinese )
		{
			drowx -= m_pC_use_grade->GetWidth(ADULT);
			//20070420 추가 12, 19세 표시 안되게... by diesirace
			if(g_pUserInformation->GoreLevel)
			{
				//m_pC_use_grade->BltLocked(g_pUserInformation->iResolution_x-m_pC_use_grade->GetWidth(ADULT)-30,50,ADULT);
				m_pC_use_grade->BltLocked(drowx,drowy,ADULT);
			}
			else
			{
				//m_pC_use_grade->BltLocked(g_pUserInformation->iResolution_x-m_pC_use_grade->GetWidth(CHILD)-30,50,CHILD);
...
#endif	//__USER_GRADE
		//m_image_spk.BltLocked(55+convx, convy+350, CHARACTER_GUARD);		
		gpC_base->m_p_DDSurface_back->Unlock();
	}
...
//	DrawCover(ENERGY_X, 482);
	...
	if(m_p_slot->Race != RACE_OUSTERS)
	{
		m_image_spk.Blt(281+convx, convy+310, SEX_DISPLAY_TOOL);
		if(m_p_slot->bl_female)
		{
			m_image_spk.Blt(341+convx,convy+337, MALE_CHECK);
			m_image_spk.Blt(366+convx,convy+337, FEMALE_BUTTON);
		}

		else
		{
			m_image_spk.Blt(341+convx,convy+310, MALE_CHECK);
			m_image_spk.Blt(366+convx,convy+310, MALE_BUTTON);
		}
	}
	if (gpC_base->m_p_DDSurface_back->Lock())
	{
		...
		if(m_p_slot->Race != RACE_VAMPIRE)
		{
			for (j=0; j < COLOR_LIST_Y; j++)
				for (i=0; i < COLOR_LIST_X; i++)
				{
					color_unit_rect.XY(TABLE_X+COLOR_UNIT_X*i+convx, convy+TABLE_Y+COLOR_UNIT_Y*j);
					
					FillRect(&surfaceinfo, &color_unit_rect, GetColor(i, j, false));
				}
				
				// show select mark
				color_unit_rect.XY(TABLE_X+m_hair_point.x*COLOR_UNIT_X+convx, convy+TABLE_Y+m_hair_point.y*COLOR_UNIT_Y);
		...
		if(m_p_slot->Race != RACE_OUSTERS)
		{
			...
			for (j=0; j < COLOR_LIST_Y; j++)
				for (i=0; i < COLOR_LIST_X; i++)
				{
					color_unit_rect.XY(TABLE_X2+COLOR_UNIT_X*i+convx, convy+TABLE_Y+COLOR_UNIT_Y*j);

					FillRect(&surfaceinfo, &color_unit_rect, GetColor(i, j, true));
				}

			// show select mark
			color_unit_rect.XY(TABLE_X2+m_skin_point.x*COLOR_UNIT_X+convx, convy+TABLE_Y+m_skin_point.y*COLOR_UNIT_Y);
			rectangle(&surfaceinfo, &color_unit_rect, ga_blink_color_table[g_blink_value]);
		}
		else
		{
	...
	ShowCharacter(95+convx, convy+455, m_p_slot, g_char_index, false);

	switch(m_p_slot->Race)
	{
	case RACE_SLAYER:
		m_image_spk.Blt(341+convx,convy+217, MALE_CHECK);
		m_image_spk.Blt(366+convx,convy+217, SLAYER_BUTTON);
		break;

	case RACE_VAMPIRE:
		m_image_spk.Blt(341+convx,convy+244, MALE_CHECK);
		m_image_spk.Blt(366+convx,convy+244, VAMPIRE_BUTTON);
		break;

	case RACE_OUSTERS:
		m_image_spk.Blt(341+convx,convy+271, MALE_CHECK);
		m_image_spk.Blt(366+convx,convy+271, OUSTERS_BUTTON);
		break;	
	}	
	...
	g_Print(725+20+convx, convy+223, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->DEX_PURE);
	g_Print(725+20+convx, convy+223+27, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->INT_PURE);
	g_Print(725+20+convx, convy+223+27*2, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->HP);
	g_Print(725+20+convx, convy+223+27*3, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->MP);
	g_Print(725+20+convx, convy+223+27*4, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->DEFENSE);
	g_Print(725+20+convx, convy+223+27*5, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->PROTECTION);
	g_Print(725+20+convx, convy+223+27*6, str, &gpC_base->m_value_pi);
	sprintf(str, "%d", m_p_slot->TOHIT);
	g_Print(725+20+convx, convy+223+27*7, str, &gpC_base->m_value_pi);
	sprintf(str, "%d~%d", m_p_slot->DAM, m_p_slot->DAM2);
	g_Print(725+20+convx, convy+223+27*8, str, &gpC_base->m_value_pi);
	if(m_p_slot->Race == RACE_OUSTERS)
	{
		sprintf(str, "%d", m_p_slot->bonus_point);
		g_Print(725+20+convx, convy+223-50, str, &gpC_base->m_value_pi);
	}
...
//	m_pC_ani_fin->Show();
	...
	if( g_LeftPremiumDays != 0xFFFF )
		g_PrintColorStr( g_vs_ui_title_only_premium_x+convx-szBufferLen, convy+g_vs_ui_title_only_premium_y, szBuffer, gpC_base->m_desc_menu_pi, RGB_WHITE );
...
//	m_pC_char_info = NULL;
	...
	Set( (g_pUserInformation->iResolution_x - m_title_spk.GetWidth(0)) / 2, 
		...
		Set(g_pUserInformation->iResolution_x/2 - m_common_spk.GetWidth()/2, g_pUserInformation->iResolution_y/2 - m_common_spk.GetHeight()/2, m_common_spk.GetWidth(), m_common_spk.GetHeight());
...
//#endif
	...
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(254, 537, m_common_spk.GetWidth(BACK_BUTTON), m_common_spk.GetHeight(BACK_BUTTON), BACK_ID, this, BACK_BUTTON));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(738, 537, m_common_spk.GetWidth(NEXT_BUTTON), m_common_spk.GetHeight(NEXT_BUTTON), NEXT_ID, this, NEXT_BUTTON));
...
//#ifdef CONVERT_1024_768
//		m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+g_heart_rect[i]+119-112, y+HEART_Y+36-84, m_image_spk.GetWidth(DELETE_BUTTON), m_image_spk.GetHeight(DELETE_BUTTON), DELETE_1_ID+i, this, DELETE_BUTTON));
//#else
...
void C_VS_UI_CHAR_MANAGER::Run(id_t id)
{
	...
	switch (id)
	{
		case CREATE_1_ID:
			...
			// search empty slot
			if (m_slot[0].bl_set == false)
			{
				m_select_heart_temp = 0;
				m_pC_newchar->Start();
				m_pC_newchar->SetCharacterToThisSlot(0, &m_slot[0]);
			...
			break;
		case CREATE_2_ID:
			if (m_slot[1].bl_set == false)
			{
				m_select_heart_temp = 1;
				m_pC_newchar->Start();
				m_pC_newchar->SetCharacterToThisSlot(1, &m_slot[1]);
			...
			break;
		case CREATE_3_ID:
			if (m_slot[2].bl_set == false)
			{
				m_select_heart_temp = 2;
				m_pC_newchar->Start();
				m_pC_newchar->SetCharacterToThisSlot(2, &m_slot[2]);
				m_pC_newchar->RollDice();
				Finish();
				return;
			}
...
/*#ifdef CONVERT_1024_768
					// hardcoding.. 쏘리.
					if(_x > x+g_heart_rect[i]-112 && _x < x+g_heart_rect[i]-112 + m_image_spk.GetWidth() &&
						_y > y+HEART_Y-84 && _y < y+HEART_Y-84 + m_image_spk.GetHeight())
#else
		...
		case M_LB_DOUBLECLICK:
			if(re == true)
			if (m_select_heart > NOT_SELECTED && m_select_heart < SLOT)
			{
...
void C_VS_UI_CHAR_MANAGER::Show()
{
	...
	if(gpC_base->m_p_DDSurface_back->Lock())
	{
		...
		if(bHighResolution)
		{
			...
			m_common_spk.BltLocked( g_pUserInformation->iResolution_x/2 - m_common_spk.GetWidth()/2 , g_pUserInformation->iResolution_y/2 - m_common_spk.GetHeight()/2 );
			m_image_spk.BltLocked(
				g_pUserInformation->iResolution_x/2 - m_common_spk.GetWidth()/2 + TITLE_X - m_image_spk.GetWidth(TITLE)/2,
				g_pUserInformation->iResolution_y/2 - m_common_spk.GetHeight()/2 + TITLE_Y , TITLE);
		}
		else
		{
...
//		m_image_spk.BltLocked( RESOLUTION_X/2 - m_common_spk.GetWidth()/2 + TITLE_X - m_image_spk.GetWidth(TITLE)/2, RESOLUTION_Y/2 - m_common_spk.GetHeight()/2 + TITLE_Y , TITLE);
//#else
//		m_common_spk.BltLocked(x, y);
//		//	m_image_spk.BltLocked(300, 150);
//		m_image_spk.BltLocked(TITLE_X - m_image_spk.GetWidth(TITLE)/2, TITLE_Y, TITLE);
//#endif
	...
	for (i = 0; i < SLOT; i++)
	{
		...
		if(m_select_heart==i)
		{
			...
			m_image_spk.Blt(x+g_heart_rect[i]+14, y+HEART_Y+52, CHARACTER_GUARD);
		}
		
//SetPrintInfo(gpC_base->m_user_id_pi)
		if (m_slot[i].bl_set)
		{
			int index;
			index = g_char_index;
			g_CurrentFrame = index;
			m_pC_newchar->ShowCharacter(x+g_heart_rect[i]+50, y+HEART_Y+150, &m_slot[i], index, (m_select_heart==i)?1:0, !(m_select_heart==i));
			...
			g_PrintColorStr(x+g_heart_rect[i]+64 - g_GetStringWidth(m_slot[i].sz_name.c_str(), gpC_base->m_user_id_pi.hfont)/2, y+HEART_Y+25, m_slot[i].sz_name.c_str(), gpC_base->m_user_id_pi, RGB_WHITE);
		}
	}
	std::string help_string[HELP_MAX] = 
	{
	...
	{
		ShowDesc(convx,convy);//새 ui가 나오기 전까지 임시 코드

	}

//#ifdef CONVERT_1024_768
//		ShowDesc(112,84);//새 ui가 나오기 전까지 임시 코드
//#else
//		ShowDesc();
//#endif
	...
	{
		g_FL2_GetDC();
		int convertValue = (g_pUserInformation->iResolution_x - 800) / 2;
		int convertY = (g_pUserInformation->iResolution_y - 600) / 2;
		


//#ifdef CONVERT_1024_768//새UI가 나오면 삭제 하드코딩;
//		int convertValue = 112;
//		int convertY = 84;
//#else
//		int convertValue = 0;
//		int convertY = 0;
...
//#endif
			...
			char str[10];
			px = g_PrintColorStr(29+convertValue, py,(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_NAME].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
			g_PrintColorStr(px, py, m_p_slot->sz_name.c_str(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
			py+=16;

			if(m_p_slot->Race != RACE_SLAYER)
			{
				px = g_PrintColorStr(29+convertValue, py, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_LEVEL].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
				wsprintf(str, "%d", m_p_slot->level);
				g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
				py+=16;
			}

			px = g_PrintColorStr(29+convertValue, py,(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_STR_PURE].GetString(),gpC_base->m_chatting_pi, RGB(160, 160, 160));
			wsprintf(str, "%d", m_p_slot->STR_PURE);
			g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
			py+=16;

			px = g_PrintColorStr(29+convertValue, py, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_DEX_PURE].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
			wsprintf(str, "%d", m_p_slot->DEX_PURE);
			g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
			py+=16;

			px = g_PrintColorStr(29+convertValue, py,(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_INT_PURE].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
			...
			case RACE_SLAYER:
				{
					...
					px = g_PrintColorStr(29+convertValue, py,(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_SWORD_LEVEL].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
					wsprintf(str, "%d", m_p_slot->DOMAIN_SWORD);
					g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
					py+=16;
					
					px = g_PrintColorStr(29+convertValue, py, 	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_BLADE_LEVEL].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
					wsprintf(str, "%d", m_p_slot->DOMAIN_BLADE);
					g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
					py+=16;
					
					px = g_PrintColorStr(29+convertValue, py, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_GUN_LEVEL].GetString(),gpC_base->m_chatting_pi, RGB(160, 160, 160));
					wsprintf(str, "%d", m_p_slot->DOMAIN_GUN);
					g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
					py+=16;
					
					px = g_PrintColorStr(29+convertValue, py, 	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_HEAL_LEVEL].GetString(),gpC_base->m_chatting_pi, RGB(160, 160, 160));
					wsprintf(str, "%d", m_p_slot->DOMAIN_HEAL);
					g_PrintColorStr(px, py, str, gpC_base->m_chatting_pi, RGB(160, 160, 160));
					py+=16;
					
					px = g_PrintColorStr(29+convertValue, py, 	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_ENCHANT_LEVEL].GetString(),gpC_base->m_chatting_pi, RGB(160, 160, 160));
					...
					for(unsigned int i = 3; i <= 13; i += 4)
						...
						px = g_PrintColorStr(29+convertValue, py, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_FAME].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
						g_PrintColorStr(px, py, sstr.c_str(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
						py+=16;
						
						if(m_p_slot->GRADE>0&&m_p_slot->GRADE<=100)
						{
							px= g_PrintColorStr(29+convertValue,py, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_GRADE].GetString(),gpC_base->m_chatting_pi, RGB(160,160,160));
							char tempstr[100];
		...
		{
			g_PrintColorStr(29+convertValue, 160+convertY, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_CREATEMSG1].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
			g_PrintColorStr(29+convertValue, 176+convertY, (*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_CREATEMSG2].GetString(), gpC_base->m_chatting_pi, RGB(160, 160, 160));
		}
		g_FL2_ReleaseDC();
	}
	...
	if( g_LeftPremiumDays != 0xFFFF )
	{
		...
		g_PrintColorStr( g_vs_ui_title_only_premium_x+convx-szBufferLen, g_vs_ui_title_only_premium_y+convy, szBuffer, gpC_base->m_desc_menu_pi, RGB_WHITE );

	}
//#ifdef CONVERT_1024_768
//		g_PrintColorStr( g_vs_ui_title_only_premium_x+112, g_vs_ui_title_only_premium_y+84, szBuffer, gpC_base->m_desc_menu_pi, RGB_WHITE );
//#else
...
//#endif
	...
	if(g_pUserInformation->GoreLevel)
	{
		...
		int szBufferLen = g_GetStringWidth(szBuffer, gpC_base->m_desc_menu_pi.hfont)/2;
			...
			m_image_spk.Blt(g_heart_rect[0]+convx, 457+convy, GRADE_DISCUSSION_DISPLAY);
			// 20070626 -38은 유무료 표시로 부터 38 픽셀 떨어져 있단 뜻
			g_PrintColorStr(g_vs_ui_title_only_premium_x+convx-szBufferLen, g_vs_ui_title_only_premium_y+convy-38, 
				szBuffer, gpC_base->m_desc_menu_pi, RGB_WHITE);
	

//#ifdef CONVERT_1024_768
//		g_PrintColorStr( 120+112, 552+84, szBuffer, gpC_base->m_desc_menu_pi, RGB_WHITE );
//#else
...
//#ifdef CONVERT_1024_768
//	m_server_x = 338+112;//+112;
//	m_server_y = 202+84;//+84;
//#else
//	m_server_x = 338;
//	m_server_y = 202;
//#endif
...
//		m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(671+112, 200+84, m_image_spk.GetWidth(SCROLL_UP_BUTTON), m_image_spk.GetHeight(SCROLL_UP_BUTTON), SCROLL_UP_ID, this, SCROLL_UP_BUTTON));
//		m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(671+112, 420+84, m_image_spk.GetWidth(SCROLL_DOWN_BUTTON), m_image_spk.GetHeight(SCROLL_DOWN_BUTTON), SCROLL_DOWN_ID, this, SCROLL_DOWN_BUTTON));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(g_heart_rect[0]+convx, 537+convy , m_common_spk.GetWidth(BACK_BUTTON), m_common_spk.GetHeight(BACK_BUTTON), BACK_ID, this, BACK_BUTTON));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(738+convx, 537+convy , m_common_spk.GetWidth(NEXT_BUTTON), m_common_spk.GetHeight(NEXT_BUTTON), NEXT_ID, this, NEXT_BUTTON));
		...
		if( validIndex && (validServer || validWorld)) 
		{
				...
				)
			{
				gC_vs_ui.RunAskCheckToEnterServerDialog(
						...
						MAKEWORD(m_bl_group,m_server_id[m_server_select]) );
			}
			else
			{
				gpC_base->SendMessage(UI_CONNECT_SERVER, m_bl_group, m_server_id[m_server_select]);
...
//	static char server_status_string[50];
	...
	int	iServerFocusHeight	= 0;
	if(m_bl_group)
		iServerFocusHeight	= m_image_spk.GetHeight(TITLE_WORLD_SELECT);
	else
		iServerFocusHeight	= m_image_spk.GetHeight(TITLE_SERVER_SELECT);
	switch (message)
	{
		case M_MOVING:
			m_focused_help = HELP_DEFAULT;
			m_focus_server = -1;
			if(_x > m_server_x && _x < x+m_server_x+328 && _y > y+m_server_y-2 && _y < y+m_server_y+iServerFocusHeight*12)
			{
				m_focus_server = (_y - m_server_y)/iServerFocusHeight+m_scroll;
...
void C_VS_UI_SERVER_SELECT::SetServerList(LPSTR *name, int *id, int *status, int size, int default_id, bool *nonpk, WORD *pwSlayer, WORD *pwVampire, WORD *pwOusters)
{
	...
	m_server_id.clear();
	m_server_status.clear();
	m_server_nonpk.clear();
	m_server_slayernum.clear();
	m_server_vampirenum.clear();
	m_server_oustersenum.clear();
	...
	for(int i = 0; i < size; i++)
	{
		...
		{
			m_server_slayernum.push_back(pwSlayer[i]);
			m_server_vampirenum.push_back(pwVampire[i]);
			m_server_oustersenum.push_back(pwOusters[i]);
		}
		if(id[i] == default_id)
		{
			m_server_select = i;
		...
		if(nonpk != NULL)
			m_server_nonpk.push_back(nonpk[i]);
	}
	CharBarCount();

//	if(m_bl_group	== true)	//true일 때가 월드 선택
//		gpC_base->SendMessage(UI_CONNECT_SERVER, m_bl_group, m_server_id[m_server_select]); m_bl_group 
}
#else
///////////////////////////////////////////////////////////////////////////////
// SetServerDefault
//
///////////////////////////////////////////////////////////////////////////////
void C_VS_UI_SERVER_SELECT::SetServerList(LPSTR *name, int *id, int *status, int size, int default_id, bool *nonpk)
{
	m_server_name.clear();
	m_server_id.clear();
	m_server_status.clear();
...
//#ifdef CONVERT_1024_768
//		m_title_spk.BltLocked(0 , 0 ) ; 
//		m_common_spk.BltLocked(RESOLUTION_X/2-m_common_spk.GetWidth()/2,RESOLUTION_Y/2-m_common_spk.GetHeight()/2);//x, y);
//		m_image_spk.BltLocked(RESOLUTION_X/2-m_common_spk.GetWidth()/2+300, RESOLUTION_Y/2-m_common_spk.GetHeight()/2+150);
...
void C_VS_UI_SERVER_SELECT::GroupView()
{
	...
	if(bHighResolution)
	{
		...
		m_common_spk.BltLocked(g_pUserInformation->iResolution_x/2-m_common_spk.GetWidth()/2, 
			g_pUserInformation->iResolution_y/2-m_common_spk.GetHeight()/2);//x, y);

		if(m_bl_group)
		{
			m_image_spk.BltLocked(g_pUserInformation->iResolution_x/2-m_common_spk.GetWidth()/2+g_heart_rect[0], 
				g_pUserInformation->iResolution_y/2-m_common_spk.GetHeight()/2+140);
			m_pC_button_group->Show();
			m_image_spk.BltLocked(TITLE_X+MODE1024_X - m_image_spk.GetWidth(TITLE_WORLD)/2, TITLE_Y+MODE1024_Y, TITLE_WORLD);
		}
		else
		{
			m_image_spk.BltLocked(g_pUserInformation->iResolution_x/2-m_common_spk.GetWidth()/2+g_heart_rect[0], 
				g_pUserInformation->iResolution_y/2-m_common_spk.GetHeight()/2+140, SUB_WINDOW);
			m_pC_button_group->Show();
			m_image_spk.BltLocked(TITLE_X+MODE1024_X - m_image_spk.GetWidth(TITLE_SERVER)/2, TITLE_Y+MODE1024_Y, TITLE_SERVER);
		}
...
void C_VS_UI_SERVER_SELECT::ServerNameView()
{
	...
	const char* pservertitle		= (*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER].GetString();
	const char* pserverstatetitle	= (*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS].GetString();
	const char* pserverchartitle	= (*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_RACE].GetString();

#if __CONTENTS(__SERVER_SELECT_REVEWAL)
	const int	iWorldText_X	= 120;
	const int	iWorldText_Y	= 20;
	const int	iServerText_X	= 23;
	const int	iServerTexStatus_X	= iServerText_X + 113;
	const int	iServerText_Y	= m_image_spk.GetHeight(TITLE_SERVER_SELECT);
	...
	for(int i = 0; i < min(m_server_name.size(), 12); i++)
	{
		...
		if(m_bl_group)
		{
			...
			{
				g_PrintColorStr(x+m_server_x, y+m_server_y+i*iWorldText_Y, m_server_name[i+m_scroll].c_str(), gpC_base->m_desc_menu_pi, RGB(255,139,00));
				g_PrintColorStr(x+m_server_x+iWorldText_X, y+m_server_y+i*iWorldText_Y, server_status_string, gpC_base->m_desc_menu_pi, RGB(255,139,00));
			}
			else
			{
				g_PrintColorStr(x+m_server_x, y+m_server_y+i*iWorldText_Y, m_server_name[i+m_scroll].c_str(), gpC_base->m_desc_menu_pi, RGB_WHITE);	
				g_PrintColorStr(x+m_server_x+iWorldText_X, y+m_server_y+i*iWorldText_Y, server_status_string, gpC_base->m_desc_menu_pi, RGB_WHITE);
			}
		}
		else
		{
				if(i+m_scroll == m_focus_server)
				{
					g_PrintColorStr(x+m_server_x + 10, y+m_server_y+(i*iServerText_Y)+(iServerText_Y/3)-i, m_server_name[i+m_scroll].c_str(), gpC_base->m_desc_menu_pi, RGB(255,139,00));
					g_PrintColorStr(x+m_server_x+iServerTexStatus_X, y+m_server_y+(i*iServerText_Y)+(iServerText_Y/3)-i, server_status_string, gpC_base->m_desc_menu_pi,  RGB(255,139,00));
				}
				else
				{
					g_PrintColorStr(x+m_server_x + 10, y+m_server_y+(i*iServerText_Y)+(iServerText_Y/3)-i, m_server_name[i+m_scroll].c_str(), gpC_base->m_desc_menu_pi, RGB_WHITE);	
					g_PrintColorStr(x+m_server_x+iServerTexStatus_X, y+m_server_y+(i*iServerText_Y)+(iServerText_Y/3)-i, server_status_string, gpC_base->m_desc_menu_pi, RGB_WHITE);
				}
				g_PrintColorStr(x+m_server_x+iServerText_X + 25, y+m_server_y - 18, pservertitle, gpC_base->m_desc_menu_pi, RGB_WHITE);
				g_PrintColorStr(x+m_server_x+iServerTexStatus_X + 5, y+m_server_y - 18, pserverstatetitle, gpC_base->m_desc_menu_pi, RGB_WHITE);
				g_PrintColorStr(x+m_server_x+iServerTexStatus_X+(iServerText_X)*4, y+m_server_y - 18, pserverchartitle, gpC_base->m_desc_menu_pi, RGB_WHITE);
		}
	}
#else
	...
	for(int i = 0; i < min(m_server_name.size(), 12); i++)
	{
		...
		{
			if(i+m_scroll == m_focus_server)
				g_PrintColorStr(x+m_server_x+5, y+m_server_y+i*20, m_server_name[i+m_scroll].c_str(), gpC_base->m_desc_menu_pi, RGB(255,139,00));
			else
...
{
	const int	iWorldBarWidth		= 0;
	const int	iWorldBarHeight		= m_image_spk.GetHeight(TITLE_WORLD_SELECT);
#if __CONTENTS(__SERVER_SELECT_REVEWAL)
	const int	iServerBarWidth		= 0;
	const int	iServerBarHeight	= m_image_spk.GetHeight(TITLE_SERVER_SELECT);
	if(m_server_select >= m_scroll && m_server_select < m_scroll+12)
	{
		...
		if(m_bl_group)
			m_image_spk.BltLocked(x+m_server_x-1, y+m_server_y+(m_server_select-m_scroll)*iWorldBarHeight-3, TITLE_WORLD_SELECT);
		else
			m_image_spk.BltLocked(x+m_server_x-1, y+m_server_y+(m_server_select-m_scroll)*iServerBarHeight-(m_server_select-m_scroll+1), TITLE_SERVER_SELECT);
	}
#else
	m_image_spk.BltLocked(x+m_server_x-1, y+m_server_y+(m_server_select-m_scroll)*iWorldBarHeight-3, TITLE_WORLD_SELECT);
#endif //__SERVER_SELECT_REVEWAL
...
void C_VS_UI_SERVER_SELECT::CharBoxView()
{
	...
	int convy = (g_pUserInformation->iResolution_y - 600) / 2;
		...
		if(!m_bl_group)
	{
		m_image_spk.BltLocked(iSlayerBoxPos_X + convx, iSlayerBoxPos_Y + convy, SLAYER_BOX);
		m_image_spk.BltLocked(iVampiresBoxPos_X + convx, iVampiresBoxPos_Y + convy, VAMPIRES_BOX);
		m_image_spk.BltLocked(iOustersBoxPos_X + convx, iOustersBoxPos_Y + convy, OUSTERS_BOX);
	}
#endif //__SERVER_SELECT_REVEWAL
}
...
{
#if __CONTENTS(__SERVER_SELECT_REVEWAL)	
	const int	iCharBarStartPos_X		= 539;
	const int	iCharBarStartPos_Y		= 204;
	const int	iBarWidth				= m_image_spk.GetWidth(iCharConnectBar);
	const int	iBarHeight				= m_image_spk.GetHeight(iCharConnectBar);
	const int	iServerHeight			= m_image_spk.GetHeight(TITLE_SERVER_SELECT) - 1;
	...
	int convy = (g_pUserInformation->iResolution_y - 600) / 2;
		...
		if(!m_bl_group)
		{
			...
			{
			iBarX	= iCharBarStartPos_X + ((iBarWidth + iCharBarSpace_X) * i) + convx;
				iBarY	= iCharBarStartPos_Y + (iCharIndex * iBarHeight + (iCharIndex * iCharBarSpace_Y) + iCharIndex) + 
												(iChannel * iServerHeight) + convy;	
...
void	C_VS_UI_SERVER_SELECT::CharBarCount()
{
	...
	if(m_server_slayernum.size() > 0)
	{
		if(m_pserver_slayernum_barcount==NULL)
			m_pserver_slayernum_barcount	= new WORD[m_server_slayernum.size()];
	}
	if(m_server_vampirenum.size() > 0)
	{
		if(m_pserver_vampirenum_barcount==NULL)
			m_pserver_vampirenum_barcount	= new WORD[m_server_vampirenum.size()];
	}
	if(m_server_oustersenum.size() > 0)
	{
		if(m_pserver_ousters_barcount==NULL)
			m_pserver_ousters_barcount		= new WORD[m_server_oustersenum.size()];
	}
	int i;
	for(i = 0; i < m_server_slayernum.size(); i++)
	{
		m_server_slayernumtotal				+= m_server_slayernum[i];
		m_pserver_slayernum_barcount[i]		= m_server_slayernum[i];
	}
	for(i = 0; i < m_server_vampirenum.size(); i++)
	{
		m_server_vampirenumtotal			+= m_server_vampirenum[i];
		m_pserver_vampirenum_barcount[i]	= m_server_vampirenum[i];
	}
	for(i = 0; i < m_server_oustersenum.size(); i++)
	{
		m_server_oustersnumtotal			+= m_server_oustersenum[i];
		m_pserver_ousters_barcount[i]		= m_server_oustersenum[i];
	}

	for(i = 0; i < m_server_slayernum.size(); i++)
	{
		m_pserver_slayernum_barcount[i] =	(WORD)(((float)m_server_slayernum[i] / (float)m_server_slayernumtotal)*10);
	...
	for(i = 0; i < m_server_vampirenum.size(); i++)
	{
		m_pserver_vampirenum_barcount[i] =	(WORD)(((float)m_server_vampirenum[i] / (float)m_server_vampirenumtotal)*10);
	...
	for(i = 0; i < m_server_oustersenum.size(); i++)
	{
		m_pserver_ousters_barcount[i] =		(WORD)(((float)m_server_oustersenum[i] / (float)m_server_oustersnumtotal)*10);
...
//	m_pC_option = NULL;
	...
	if(bHighResolution)
		m_title_spk.Open(SPK_TITLE_1024);
	else	m_title_spk.Open(SPK_TITLE);
...
//#ifdef CONVERT_1024_768
	//Set(RESOLUTION_X/2 - m_title_spk.GetWidth()/2, RESOLUTION_Y/2 - m_title_spk.GetHeight()/2, m_title_spk.GetWidth(), m_title_spk.GetHeight());
	//Set(0, 0, RESOLUTION_X , RESOLUTION_Y );//m_title_spk.GetWidth(), m_title_spk.GetHeight());
//#else
//	Set(0, 0, m_title_spk.GetWidth(), m_title_spk.GetHeight());
//#endif
...
//	m_pC_ani_symbol->SetSpeed(70);
	...
	m_pC_button_group = new ButtonGroup(this);
/*#ifdef CONVERT_1024_768
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+673+112, y+371+84, m_title_menu_default.GetWidth(CONNECT_HILIGHT), m_title_menu_default.GetHeight(CONNECT_HILIGHT), CONNECT, this,CONNECT_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+673+112, y+419+84, m_title_menu_default.GetWidth(OPTION_HILIGHT), m_title_menu_default.GetHeight(OPTION_HILIGHT), OPTION, this,OPTION_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+673+112, y+467+84, m_title_menu_default.GetWidth(CREDIT_HILIGHT), m_title_menu_default.GetHeight(CREDIT_HILIGHT), CREDIT, this,CREDIT_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(x+673+112, y+515+84, m_title_menu_default.GetWidth(EXIT_HILIGHT), m_title_menu_default.GetHeight(EXIT_HILIGHT), EXIT, this,EXIT_HILIGHT));
#else*/

	//int iStartRangeX = RESOLUTION_X - 159 , iStartRangeY  = RESOLUTION_Y - 238 ;
	//20070517 by diesirace
	//여기가 버튼을 등록하고 위치를 정하는곳
	...
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(iStartRangeX + offsetX + 126, iStartRangeY, m_title_menu_default.GetWidth(CONNECT_HILIGHT), m_title_menu_default.GetHeight(CONNECT_HILIGHT), CONNECT, this,CONNECT_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(iStartRangeX + offsetX, iStartRangeY + 100, m_title_menu_default.GetWidth(NEWID_HILIGHT), m_title_menu_default.GetHeight(NEWID_HILIGHT), NEWID, this,NEWID_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(iStartRangeX + offsetX + 93, iStartRangeY + 100, m_title_menu_default.GetWidth(OPTION_HILIGHT), m_title_menu_default.GetHeight(OPTION_HILIGHT), OPTION, this,OPTION_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(iStartRangeX + offsetX, iStartRangeY + 130, m_title_menu_default.GetWidth(CREDIT_HILIGHT), m_title_menu_default.GetHeight(CREDIT_HILIGHT), CREDIT, this,CREDIT_HILIGHT));
	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(iStartRangeX + offsetX + 93, iStartRangeY + 130, m_title_menu_default.GetWidth(EXIT_HILIGHT), m_title_menu_default.GetHeight(EXIT_HILIGHT), EXIT, this,EXIT_HILIGHT));
...
//	m_pC_button_group->Add(new C_VS_UI_EVENT_BUTTON(347+17, 319, m_title_menu_default.GetWidth(INTRO), m_title_menu_default.GetHeight(INTRO), INTRO, this));
	...
	{
		m_lev_id.SetPosition(iStartRangeX+offsetX+LOGIN_ID_X, iStartRangeY+LOGIN_ID_Y);
		...
		m_lev_password.SetPosition(iStartRangeX+offsetX+LOGIN_PASSWORD_X, iStartRangeY+LOGIN_PASSWORD_Y);
		m_lev_password.PasswordMode(true);
...
//	//20090311 테스트 코드 꼭 지웁시다.
//	m_lev_id.EraseAll();
//	m_lev_password.EraseAll();
//	m_lev_id.AddString("JM0002694158");
//	m_lev_password.AddString("softon");
...
//#endif
	...
	if(gpC_base->m_p_DDSurface_back->Lock())
	{
		if (m_bl_credit)
		{
			...
			m_pC_credit->BltLocked(g_pUserInformation->iResolution_x/2-m_pC_credit->GetWidth()/2, g_pUserInformation->iResolution_y/2-m_pC_credit->GetHeight()/2);
			int scroll = ( (m_credit_scroll < 0)? 0 : m_credit_scroll );
			int scroll2 = ( (m_credit_scroll < 0)? m_credit_scroll : m_credit_scroll );
			//int scroll3 = ( (m_credit_scroll < 0)? RESOLUTION_Y+m_credit_scroll : RESOLUTION_Y );
			...
			//m_pC_credit->BltLockedClip(scroll_x +m_pC_credit->GetWidth(1)/2-m_pC_credit->GetWidth(2)/2, scroll_y + max((RESOLUTION_Y-70)/2, (m_pC_credit->GetHeight(1) - scroll + 50) ), rect2, 2);
			m_pC_credit->BltLockedClip(scroll_x +m_pC_credit->GetWidth(1)/2-m_pC_credit->GetWidth(2)/2, scroll_y + max((g_pUserInformation->iResolution_y-70)/2, (m_pC_credit->GetHeight(1) - scroll + 50) ), rect2, 2);
			//return;
		...
		{
			//20070517 by diesirace 
			//여기가 1024/800그림 뿌리는곳 뿌리는 방식이 달랐으나 이미지 리뉴얼 하면서 통합
//			if(g_pUserInformation->IsResolution1024)
			//			{
			m_title_spk.BltLocked(g_pUserInformation->iResolution_x/2-m_title_spk.GetWidth()/2, g_pUserInformation->iResolution_y/2-m_title_spk.GetHeight()/2);

			if(false == g_pUserInformation->IsAutoLogIn &&
			   false == g_pUserInformation->IsNetmarbleLogin)
			{
				m_title_spk.BltLocked(0, g_pUserInformation->iResolution_y - m_title_spk.GetHeight(1), 1);
			}
			else
			{
				m_title_spk.BltLocked(0, g_pUserInformation->iResolution_y - m_title_spk.GetHeight(1), 5);
			}
		
			m_title_spk.BltLocked(0 , 0 , 3);
			
			m_title_spk.BltLocked(g_pUserInformation->iResolution_x - m_title_spk.GetWidth(2), g_pUserInformation->iResolution_y-m_title_spk.GetHeight(2) , 2);

			//타오르는 눈알을 정확한 위치에 뿌린다.
			//타오르는 눈알을 구현 
			if(m_pAnimationTimer->IsTimeLimit())
			{
				if(m_bAniArphaUp)
			...
			m_title_spk.BltLockedAlpha(
				g_pUserInformation->iResolution_x - (1024 - 768),
				g_pUserInformation->iResolution_y - (768 - 215), 4, m_aniArpha);
...
/*
#ifdef CONVERT_1024_768
			m_title_spk.BltLocked(RESOLUTION_X/2-m_title_spk.GetWidth()/2, RESOLUTION_Y/2-m_title_spk.GetHeight()/2);
			m_title_spk.BltLocked(RESOLUTION_X - 159 , RESOLUTION_Y - 238 , 1);
			
			m_title_spk.BltLocked(0 , 0 , 3);


			m_title_spk.BltLocked(0 , RESOLUTION_Y-m_title_spk.GetHeight(2) , 2);
...
//					m_pC_use_grade->BltLocked(g_pUserInformation->iResolution_x-m_pC_use_grade->GetWidth(ADULT)-30,30,ADULT);
//				}
//				//타이틀 쪽에 심의 등급 관련 
//				//표시가 있었던듯 지금은 m_pC_use_grade가 널로 들어 온다 파일을 읽지 않는다는 이야기
//				else
//				{
//					//m_pC_use_grade->BltLocked(RESOLUTION_X-m_pC_use_grade->GetWidth(CHILD)-30,30,CHILD);
//					m_pC_use_grade->BltLocked(g_pUserInformation->iResolution_x-m_pC_use_grade->GetWidth(CHILD)-30,30,CHILD);
//				}
//			}
#if	__CONTENTS(__USER_GRADE)
...
/*
				//20070420 추가 12, 19세 표시 안되게... by diesirace
//				m_pC_use_grade->BltLocked(drowx,drowy,ADULT);
//				drowx -= m_pC_use_grade->GetWidth(CHILD);
//				m_pC_use_grade->BltLocked(drowx,drowy,CHILD);

*//* -- Netmarble의 경우, 실행인자로 유저의 나이값을 받아, GoreLevel값을 초기화 할 수 있으므로.. 로긴창에서의 이용제한UI표시에 반영해야 한다. --*/
				if(g_pUserInformation->IsNetmarble)
				{
					if(g_pUserInformation->GoreLevel)
					{
...
//			testpoint.x	= 400;
//			testpoint.y	= 400;
//			g_pTopView->DrawTitleEffect(&testpoint);
			...
			if(g_pUserInformation->IsNetmarble)
				...
				g_PrintColorStr(g_pUserInformation->iResolution_x - 50 -g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), g_pUserInformation->iResolution_y -30, sz_temp, gpC_base->m_info_pi, RGB_WHITE);

//#ifdef CONVERT_1024_768
//			g_PrintColorStr(RESOLUTION_X - 50 -g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), RESOLUTION_Y-30, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
//#else
...
//#endif
			...
			{
				if( m_iWarmingTextIndex )//0,1
				{
					sprintf(sz_temp, "%s" ,(*g_pGameStringTable)[STRING_MESSAGE_WARMING_LOGIN1].GetString());

						g_PrintColorStr(700-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), g_pUserInformation->iResolution_y-60, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
					

//#ifdef CONVERT_1024_768
//					g_PrintColorStr(700-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), RESOLUTION_Y-60, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
//#else
//					g_PrintColorStr(500-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), 550, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
//#endif
					
				}
				else
				{
					sprintf(sz_temp, "%s" ,(*g_pGameStringTable)[STRING_MESSAGE_WARMING_LOGIN2].GetString());

						g_PrintColorStr(750-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), g_pUserInformation->iResolution_y-60, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
					

//#ifdef CONVERT_1024_768
//					g_PrintColorStr(750-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), RESOLUTION_Y-60, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
//#else
//					g_PrintColorStr(600-g_GetStringWidth(sz_temp, gpC_base->m_info_pi.hfont), 550, sz_temp, gpC_base->m_info_pi, RGB_WHITE);
//#endif					
	...
	case M_LB_DOUBLECLICK:
		{
			if(false == g_pUserInformation->IsAutoLogIn &&
		       false == g_pUserInformation->IsNetmarbleLogin)
			{
				Rect id_rt(iStartRangeX + LOGIN_ID_X + offsetX,iStartRangeY + LOGIN_ID_Y, 130, 23);
				Rect pass_rt(iStartRangeX + LOGIN_PASSWORD_X + offsetX,iStartRangeY +  LOGIN_PASSWORD_Y, 130, 23);
				if (id_rt.IsInRect(_x, _y))
				{
					if (!m_lev_id.IsAcquire())
						ChangeFocus();
