...
//	bool	IsOpen()	{ return m_bl_opened; }
	...
	void	SetHotkey(HOTKEY hotkey , int slot)	;
...
private:
	...
	C_VS_UI_SLAYER_GEAR *		m_pC_gear_other;
...
#if __CONTENTS(__GEAR_SWAP_CHANGE)	//C_VS_UI_SLAYER		슬레이어 장착창 교체 실행 함수 선언
	void	RunGearChange();
...
public:
	C_VS_UI_SLAYER_PORTAL( int nExtendLevel );
