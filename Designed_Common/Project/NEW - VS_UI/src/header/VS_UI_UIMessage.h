...
//	UI_USE_SERUM,	// 혈청사용하기
	...
	UI_ITEM_INSERT_TO_INVENTORY_SUB,// sub inventory 아이템 인설트 20070330

	UI_ITEM_USE_SUBINVENTORY,
	UI_WEDDING_CONTRIBUTION , //축의금 입력 ok
	UI_NETMARBLE_AGREEMENT, // 넷마블 사용자 약관 동의 
	UI_BLOOD_BURST,  // 폭죽 버튼 처리( 0 : 공격  ,  1 : 방어 , 2 : 파티 )  
	UI_CLIENT_REMOVE_EFFECT_STATUS,
	UI_MARKET_ACCOUNT,   //( 0 : Market 1 : Bag  2 : HomePage) 
	UI_NONPK_SERVER_USE,
	
	UI_PLAYER_PETINFO,
	UI_FORCEATTACK_SET,//강제 공격 처리
// by svi
#if __CONTENTS(__AUTO_ATTACT)	//__AUTO_ATTACT
	UI_AUTOATTACK_SET,
#endif //__AUTO_ATTACT
// end
	UI_SCREENSHOT,//스크린샷 명령어 처리

	UI_UPDATE_AVAILABLE_SKILLS,			// 사용 가능한 스킬을 업데이트 한다.

	UI_PLAYER_ACTION_TO_SEND_PACKET,	// 플레이어가 사용한 액션을 서버에 전송한다.
	
	UI_RELOAD_INFO_FILE,				// info 파일 다시 읽기

	UI_ITEM_USE_GEAR_CHANGE,			// Gear에서 사용.	left : focus slot    void_ptr : item_ptr
	
	UI_TIPOYU_MOVE,

	UI_ITEM_SHOW_AND_CREATE_ITEM,		// ItemShow 에서 사용
	UI_ITEM_SHOW_AND_CLEAR_ITEM,

	UI_SELECT_WEEKITEM,					// 선택된 프리미엄 아이템 지급 요청
	UI_SELECT_ALL_WEEKITEM,				// 프리미엄 아이템 모두 지급 요청
	UI_FINISH_PREMIUM_GIVEITEM_BUTTON,	// 프리미엄 지급 창 띄우는 아이콘 끝내기

	UI_REQUEST_REPAIRINFO,

	UI_USE_PET_MIXING_FORGE,			// 펫조합기 사용
	UI_CLOSE_PET_MIXING_FORGE,			// 펫조합기 닫기

	UI_MOVE_ZONE,						// MoveZone 에서 사용

	UI_DESTROY,
#if __CONTENTS(__FRIEND_ADDITION)
	UI_FRIEND_INFO_DATA,
	UI_FRIEND_SYSTEM_OPTION,
	UI_FRIEND_INFO_OPTION,
	UI_FRIEND_ADD,
	UI_FRIEND_RES_ADD,
	UI_FRIEND_DEL,
	...
	UI_REQUEST_TMALL_LIST,

	UI_REQUEST_PAY_EVENT,

	UI_PAY_GET_ITEM,

	UI_BUY_TMALL_ITEM,

	UI_REQUEST_MILITARY_SLOTDATA,

	UI_ITEM_DROP_TO_MILITARYSLOT,
	UI_ITEM_DELETE_FROM_MILITARYSLOT,
	UI_NEW_OPTION,
