...
// C_VS_UI_STORAGE
//
// 보관함. 보관한 1, 2, 3 ,  4 , 5 으로 tab이 있다. Shop 인터페이스와 같은 형태이다.
//-----------------------------------------------------------------------------
//#define STORAGE_TAB1_ID					0
//#define STORAGE_TAB2_ID					1
//#define STORAGE_TAB3_ID					2
//#define STORAGE_TAB4_ID					3
//#define STORAGE_TAB5_ID					4
//#define STORAGE_CLOSE_ID				5
//#define STORAGE_HELP_ID					6
//#define	STORAGE_MONEY_ID				7
...
#define STORAGE_HELP_ID				6
#define STORAGE_MONEY_ID			7
//#define STORAGE_TAB4_ID				6
//#define STORAGE_TAB5_ID				7
...
public:
	enum IMAGE_SPK_INDEX
	{
		...
		STORAGE_NEWTAB1_HILIGHTED,
		STORAGE_NEWTAB2_HILIGHTED,
		STORAGE_MEWTAB3_HILIGHTED,
		STORAGE_NEWTAB4_HILIGHTED,
		STORAGE_NEWTAB5_HILIGHTED,

		STORAGE_NEWTAB1_HILIGHTED_PUSHED,
		STORAGE_NEWTAB2_HILIGHTED_PUSHED,
		STORAGE_NEWTAB3_HILIGHTED_PUSHED,
		STORAGE_NEWTAB4_HILIGHTED_PUSHED,
		STORAGE_NEWTAB5_HILIGHTED_PUSHED
