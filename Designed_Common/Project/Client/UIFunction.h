...
extern void		UI_SetCharInfoLuck(int value);
extern void		UI_SetCharInfoHpSteal(int value);
extern void		UI_SetCharInfoMpSteal(int value);
extern void		UI_SetCharInfoAllRes(int value);
...
extern void		UI_RunTMall(GCTMallGoodsList* pPacket);
extern void     UI_RunPayEvent(GCPayEventList* pPacket);
extern void		UI_RunMilitary(GCSendRankGemData* pPacket);
extern void		UI_RunHollyWar(GCSendNewWarInfo* pPacket);
...
extern void		UI_OkMixingForgeCoreZap(Grade_t parameter, MItem* pItem, MItem* pItem2);
...
extern void		UI_PopupMessage(int gamestringID,int x=-1, int y=-1, WORD fButton = 1, bool IsAfterExit = false);
extern void		UI_PopupStrMessage(const char* szString, int x=-1, int y=-1, WORD fButton = 1, bool IsAfterExit = false);
...
extern void		UI_SetGuildName(WORD guildID, const std::string& guildName);
...
extern void		UI_RunModifyTax(int	TexRate);
...
extern void		UI_CloseSubInventory(TYPE_OBJECTID subInventory);
extern void		UI_CloseAllSubInventory();
extern void		UI_ClearSubInventory();
extern bool		UI_AddItemToSubInventory(TYPE_OBJECTID subInventory, MItem *pItem, int X, int Y);
extern bool		UI_IsRunAskUseItemDialog() ; 
extern void		UI_RunAskUseItemDialog(int AskType , int value = 0, void* pValue = NULL) ; 
...
extern void		UI_BLOODBURST_ATTACKGAGEFULL() ;
extern void		UI_BLOODBURST_DEFENSEGAGEFULL() ;
extern void		UI_BLOODBURST_PARTYGAGEFULL() ;

extern void		UI_RunAskCheckToEnterServerDialog(int AskType , int value = 0) ; 

extern void		UI_RunTimeCount(DWORD sec, LPCTSTR desc);
extern void		UI_CloseTimeCount();
extern void		UI_ClosePetMixingForge();
extern void		UI_OKPetMixingForge(MItem* pItem);

#if __CONTENTS(__FRIEND_ADDITION)
extern void		UI_GeneratePlayerPopupMenu(int _x, int _y, TYPE_OBJECTID id);
extern void		UI_ReleasePlayerPopupMenu(int _x, int _y);
