...
//--------------------------------------------------------------------------
void
MFileInfo::LoadFromFile(ivfstream& file)
{
...
MZLib::Compress(const char* filename)
{
	...
	std::ofstream packFile(filename, std::ios::binary | std::ios::trunc);
...
// 	}
	...
	ivfstream packFile(filename, std::ios::binary);
	...
	while (iInfo != m_listFileInfo.end())
	{
		...
		std::ofstream file( writeFilename, std::ios::binary | std::ios::trunc );		
...
//--------------------------------------------------------------------------
void
MZLib::ReadBufferFromFile(ivfstream& packFile, long bytes)
{
...
//--------------------------------------------------------------------------
bool				
MZLib::ReadFileInfoFromFile(ivfstream& packFile)
{
	ReleaseFileInfo();	
