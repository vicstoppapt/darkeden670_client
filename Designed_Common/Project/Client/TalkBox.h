...
class PCTalkBox : public MStringList
{
	...
	public :
		...
		//NPC대화상자를 세팅할때 반복 되는 코드들이 있어서 통일화 한 함수
		void				SetNPCTalkBox(int talkBoxType, const char* content, unsigned int NPCID, unsigned int CreatureType, unsigned int sid);
