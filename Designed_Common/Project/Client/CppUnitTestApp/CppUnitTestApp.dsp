...
# ADD CPP /nologo /MD /W3 /GR /GX /Zi /O2 /I "../../../include" /I "../.." /I "suites" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "CPPUNIT_USE_TYPEINFO" /FR /YX /FD /c
...
TargetPath=.\Release\CppUnitTestApp.exe
SOURCE="$(InputPath)"
...
# Begin Special Build Tool
TargetPath=.\Debug\CppUnitTestApp.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Unit testing...
PostBuild_Cmds=$(TargetPath)
# End Special Build Tool
...
SOURCE=.\testrunner.dll

!IF  "$(CFG)" == "CppUnitTestApp - Win32 Release"

# Begin Custom Build - $(IntDir)\$(InputName).dll
IntDir=.\Release
InputPath=.\testrunner.dll
