...
//	}
	...
	return	(g_pCGameUpdate->GetForceAttack()
...
{
	// 상점을 왜치니 -_-
	if(pCreature->CurPernalShop() == 1) return FALSE;
...
//----------------------------------------------------------------------
// Can Force Attack (MCreature*)
//----------------------------------------------------------------------
// 강제 공격 할 수 있는 놈인가?
//----------------------------------------------------------------------
BOOL	
MObjectSelector::CanForceAttack(MCreature* pCreature)
{
	return pCreature->CurPernalShop() != 1;
}
