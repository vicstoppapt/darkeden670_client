...
// load from file
//--------------------------------------------------------------------------------
void Update::load ( std::ifstream & ifile ) 
{
...
// save to file
//--------------------------------------------------------------------------------
void Update::save ( std::ofstream & ofile ) const 
{
	//--------------------------------------------------------------------------------
	// save update type
	//--------------------------------------------------------------------------------
...
//			if (PUUFMoveFile( tempFile.c_str(), destFile.c_str() ))
			{
				return true;
			}
		}
		...
		{
//			if (PUUFDeleteFile( m_Params[0].c_str() ))
			{
				return true;
			}
		}
...
//			if (PUUFAppendPack( tempSPK.c_str(),		// src-spk
...
//			if (PUUFAppendPack( tempFPK.c_str(),		// src-fpk
//								destFPK.c_str() ))		// dest-fpk
			{
				return true;
			}
...
//			if (PUUFAppendInfo( tempINF.c_str(),		// src-info
