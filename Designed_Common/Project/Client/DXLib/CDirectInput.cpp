...
- SystemParametersInfo()�� ���� Mouse ������ ������ Mouse ���Ӱ��� ��´�.
-----------------------------------------------------------------------------*/
int CDirectInput::GetMouseAcceleration(int value)
{
	...
	// 6: (4,  6, 2)
	//
	// accel level�� 0�� �ƴ� ��, value�� ù��° �Ѱ谪���� ũ�� value�� 2�� �Ѵ�.
	// accel level�� 2�� ���� �ι�° �Ѱ谪���� ũ�� value�� 2���� ���� �� 2�� �Ѵ�.
	//
...
{
	//
	// m_mouse_info�� three integer array�̴�.
	//
...
void CDirectInput::OnKeyboardInput()
{
    if (m_pKeyboard)
    {
        ...
        while ( DI_OK != hr )
        {
			...
			hr = m_pKeyboard->Acquire(); //by viva
                if ( FAILED(hr) )  
                    return;
    ...
    while ( !bDone ) 
    {
        ...
        {     
            ...
            case DIMOFS_Z:       // Mouse vertical motion 
					m_mouse_z += od.dwData; // �Ϲ������� wheel�� �Ե��� 120�̴�.
					if (m_fp_mouse_event_receiver)
					{
						// m_mouse_z�� ��ȯ�ؼ� �Ѱ��ٱ�?
						if ((int)od.dwData < 0)
...
- Direct Input�� �ʱ�ȭ�Ѵ�.
  ...
  `DirectDraw�� ������� �ʰ� DirectInput�� ����� �� �����Ƿ� Window handle�� 
   ���ڷ� �޴´�. ��, hWnd�� ���� DirectInput�� ����Ѵ�.
-----------------------------------------------------------------------------*/
HRESULT CDirectInput::InitDI(HWND hWnd, HINSTANCE hInst, E_EXCLUSIVE ex)
{
    ...
    // DirectInput applications.
	 //
	 // Keyboard�� ���ؼ��� Windows�� �׻� Exclusive�� ����ϹǷ� Application������
	 // None-Exclusive�� �ۿ� �� �� ����. �̰��� �������� alt+tab, ctrl+alt+del�� 
	 // ���� Ű�Է��� ��ȿ�ϰ� �ϱ� �����̴�.
	 //
