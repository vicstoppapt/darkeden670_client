...
#define UI_DIALOG_TITLE_OK						0x0004
#define UI_DIALOG_TITLE_CANCEL					0x0008

#define	FLAG_UIDIALOG_LOCK_PCTALK			0x01
#define	FLAG_UIDIALOG_LOCK_MESSAGE			0x02
//#define	FLAG_UIDIALOG_LOCK_HELP			0x08
...
class UIDialog {
	...
	public :
		...
		void			PopupFreeMessageAndItemDlg(const char* msg, int Item_FrameID, int x=-1, int y=-1, WORD fButton = UI_DIALOG_OK, bool IsAfterExit = false);		// -1은 center를 의미한다.(default)
#endif //__DYNAMIC_UI
