...
class MActionResultNode {
	public :
		...
		virtual bool		IsNodeChangeItemThirdOptionInInventory() const		{ return false; }
		virtual bool		IsNodeCreatureSnipping2() const	{ return false; }
...
class MActionResultNodeCreatureSnipping2 : public MActionResultNode {
public :
	MActionResultNodeCreatureSnipping2(TYPE_OBJECTID tid=0) { m_TargetID = tid; }
	~MActionResultNodeCreatureSnipping2() {}

	//------------------------------------------------------
	// ActionResult의 종류
	//------------------------------------------------------
	TYPE_ACTIONRESULTID		GetType() const		{ return ACTIONRESULTNODE_CREATURE_SNIPPING_2; }

	//------------------------------------------------------
	// class type
	//------------------------------------------------------
	bool		IsNodeCreatureSnipping2() const		{ return true; }
...
class MActionResultNodeAddItemOptionThreeInInventory : public MActionResultNode {
	public :
		MActionResultNodeAddItemOptionThreeInInventory(TYPE_OBJECTID tid=0, DWORD type = 0) { m_TargetID = tid; m_Type = type; }
		~MActionResultNodeAddItemOptionThreeInInventory() {}
...
class MActionResultNodeChangeItemThirdOptionInInventory : public MActionResultNode {
	public :
		MActionResultNodeChangeItemThirdOptionInInventory(tag_ThirdOptionData* type, TYPE_OBJECTID tid=0);
		~MActionResultNodeChangeItemThirdOptionInInventory() {}
		...
		// class type
		//------------------------------------------------------
		bool		IsNodeChangeItemThirdOptionInInventory() const		{ return true; }

		//------------------------------------------------------
		// Set
		//------------------------------------------------------
		void		SetItemID(TYPE_OBJECTID tid)	{ m_TargetID = tid; }
		void		SetOption(tag_ThirdOptionData* type);
	...
	public :
		TYPE_OBJECTID				m_TargetID;
		std::list<WORD>				m_ThirdOptionList;
		WORD						m_ThirdOptionType;
};
