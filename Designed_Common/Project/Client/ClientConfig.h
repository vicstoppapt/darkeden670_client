...
class ClientConfig {
	...
	public :
		...
		MString		URL_HOMEPAGE_NEW_USER_NETMARBLE;// 넷 마블 URL
		...
		DWORD		DELAY_PLAYER_RESURRECT_TIMEOUT_SIEGEWAR;
		DWORD		DELAY_PLAYER_RESURRECT_TIMEOUT_SURVIVALZONE;
	...
	//	BYTE		REGEN_AMOUNT_RAGEOFBLOOD; //rallser
		...
		// 공격 준비 동작 지속 시간 
		//--------------------------------------------------------------
		DWORD		BATTLE_STAND_KEEP_TIME;	// msec
};
