...
//	fprintf(fp,"CDataTable : %d\n",sizeof(CDataTable) );
	...
	fprintf(fp,"MTopView : %d\n",sizeof(MTopView) );
	fprintf(fp,"MStopZoneRectRandomPixelEffectGenerator : %d\n",sizeof(MStopZoneRectRandomPixelEffectGenerator) );
	fprintf(fp,"MAttackCreatureAroundThrowEffectGenerator: %d\n",sizeof(MAttackCreatureAroundThrowEffectGenerator) );
