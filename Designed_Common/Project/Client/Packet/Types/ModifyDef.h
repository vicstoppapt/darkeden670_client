...
enum ModifyType {
	...
	MODIFY_ATTACK_BLOOD_BURST_POINT,	// 공격 폭주 포인트
	MODIFY_DEFENSE_BLOOD_BURST_POINT,	// 수비 폭주 포인트
	MODIFY_PARTY_BLOOD_BURST_POINT,		// 파티 폭주 포인트

	MODIFY_ADVANCED_SLAYERSTR,			//승직 슬레 보너스 포인트
	MODIFY_ADVANCED_SLAYERDEX,			//승직 슬레 보너스 포인트
	MODIFY_ADVANCED_SLAYERINT,			//승직 슬레 보너스 포인트
