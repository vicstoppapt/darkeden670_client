...
{ 
	...
	"HELMET4" , //by viva 171
	"HELMET5" ,	//by viva 191
	"HELMET6" ,//by rallser201
	"HELMET7" ,//by rallser231
};
...
const string VampireArmType2String[] =
{
	"VAMPIRE_ARM_NONE",
	"VAMPIRE_ARM_WEAPON",
...
const std::string OustersArmType2String[] =
{
	...
	"OUSTERS_ARM_CHAKRAM_231",	//by rallser231
	"OUSTERS_ARM_MAX"
};
...
// by sigi. 2002.9.16
const uint maxSlayerAttr = 20000;
const uint maxVampireAttr = 20000;
const uint maxOustersAttr = 20000;
...
//////////////////////////////////////////////////////////////////////////////
// GearSlotID
#if __CONTENTS(__GEAR_SWAP_CHANGE)	// GearSlotID_t의 자료형 선언 (typedef	ushort)
