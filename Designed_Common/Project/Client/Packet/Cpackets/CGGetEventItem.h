...

{
	...
	EVENT_TYPE_200507_COMEBACK_ITEM,			// 돌아온 사용자에게 아이템 주기 이벤트 2005.7

	EVENT_TYPE_200507_COMEBACK_PREMIUM_ITEM,	// 돌아온 사용자 결제 시 아이템 주기 이벤트 2005.7

	EVENT_TYPE_200507_COMEBACK_RECOMMEND_ITEM,	// 돌아온 사용자 결제 시 추천 받은 자 아이템 주기 이벤트 2005.7
