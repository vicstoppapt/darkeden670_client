...
public :
	...
	const std::pair<WORD,DWORD> popFrontListElement() throw() { std::pair<WORD,DWORD> ret = m_EList.front(); m_EList.pop_front(); return ret; }

	std::list<std::pair<WORD,DWORD> >& GetList() { return m_EList; }
protected :
	...
	// Status List
	std::list<std::pair<WORD,DWORD> > m_EList;
