	 ...
	 throw ( ProtocolException , Error )
{
	...
	else
	{
		...
		/*	case SKILL_ADV2_SUDDEN_BLAST:
				{
				ExecuteActionInfoFromMainNode(
							SKILL_CLIENT_DUCKING_WALLOP2,						// 사용 기술 번호
			...
			break;
		        ...
		        case SKILL_ATTRACT_CIRCLE:

				ExecuteActionInfoFromMainNode(
							SKILL_ATTRACT_CIRCLE,										// 사용 기술 번호
		...
		case SKILL_BOMB_CRASH_WALK:
			{
				ExecuteActionInfoFromMainNode(
							SKILL_CLIENT_BOMB_CRASH_WALK,						// 사용 기술 번호
			...
			break;
		case SKILL_ATTRACT_SWORD_CRASH_1:
			{
				ExecuteActionInfoFromMainNode(
					SKILL_CLIENT_ATTRACT_SWORD_CRASH,						// 사용 기술 번호
			...
			break;
		case SKILL_ATTRACT_SWORD_CRASH_2:
			{
				ExecuteActionInfoFromMainNode(
					SKILL_CLIENT_ATTRACT_SWORD_CRASH_2,						// 사용 기술 번호
		...
		case SKILL_ACCELERATE_CHARGE_2: 
			...
			break;
		case SKILL_WARP_PORTAL:
			{
				int useSkillChar = SKILL_CLIENT_WARP_PORTAL_SLAYER_MALE ;
				if(pCreature->IsMale())
					useSkillChar = SKILL_CLIENT_WARP_PORTAL_SLAYER_MALE;
				else
					useSkillChar = SKILL_CLIENT_WARP_PORTAL_SLAYER_FEMALE;

				ExecuteActionInfoFromMainNode(
					useSkillChar,										// 사용 기술 번호
