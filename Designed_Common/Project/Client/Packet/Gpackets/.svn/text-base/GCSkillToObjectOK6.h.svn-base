...
public :
	...
	PacketSize_t getPacketSize() const throw() { return szCoord*2 + szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketSize(); }
...
public :
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const throw() { return szCoord*2+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketMaxSize(); }
};
