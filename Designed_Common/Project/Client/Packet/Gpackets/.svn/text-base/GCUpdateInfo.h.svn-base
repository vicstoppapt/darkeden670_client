...
#if __CONTENTS(__TIPOJYU_CASTLE) // GCUpdateInfoFactory	패킷 파일 쓰기		
...
#if __CONTENTS(__TIPOJYU_CASTLE) // GCUpdateInfoFactory		InstanceDoungeonInfo 선언
	//--------------------------------------------------------------------------------
...
#if __CONTENTS(__TIPOJYU_CASTLE) // GCUpdateInfoFactory		InstanceDoungeonInfo 패킷 사이즈 추가		서버에서 아직 준비 안됨
