	 ...
	 throw ( Error )
{
	...
	if (pCreature==NULL)
	{
		...
		if( pPacket->getSkillType() == SKILL_JABBING_VEIN || pPacket->getSkillType() == SKILL_MOLE_SHOT ||
					...
					pPacket->getSkillType() == SKILL_ULTIMATE_BLOW || pPacket->getSkillType() == SKILL_HARPOON_BOMB  || pPacket->getSkillType() == SKILL_GAE_BULGA || pPacket->getSkillType() == SKILL_ATTRACT_CIRCLE)
		{
	...
	else
	{
		...
		if( actionInfo == SKILL_JABBING_VEIN || actionInfo == SKILL_TRIDENT || actionInfo == SKILL_MOLE_SHOT ||
			actionInfo == SKILL_QUICK_FIRE || actionInfo == SKILL_ULTIMATE_BLOW || pPacket->getSkillType() == SKILL_HARPOON_BOMB  || actionInfo == SKILL_GAE_BULGA || actionInfo == SKILL_ATTRACT_CIRCLE)
		{
