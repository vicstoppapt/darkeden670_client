	 ...
	 throw ( Error )
{
	...
	else
	{
		...
		{			
			...
			else if(skillID == SKILL_STRATEGIC_BOMBER_1)
			{
				ExecuteActionInfoFromMainNode(SKILL_CLIENT_STRATEGIC_BOMBER_EXPLOSION,pPacket->getX(), pPacket->getY(), 0,0,0	,	
					pPacket->getX(), pPacket->getY(), 0, ConvertDurationToFrame( pPacket->getDuration() ), NULL, false);
			}
			else if(skillID == SKILL_STRATEGIC_BOMBER_2)
			{
				ExecuteActionInfoFromMainNode(SKILL_CLIENT_STRATEGIC_BOMBER_2_EXPLOSION,pPacket->getX(), pPacket->getY(), 0,0,0	,	
					pPacket->getX(), pPacket->getY(), 0, ConvertDurationToFrame( pPacket->getDuration() ), NULL, false);
			}
			...
			{
			   SkillBatStorm1( pCreature,pCreature,pPacket->getX(), pPacket->getY(), SKILL_CLIENT_BAT_BREAKER);
			}
