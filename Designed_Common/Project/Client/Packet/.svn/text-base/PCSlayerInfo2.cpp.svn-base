...
// <망각의 수정>		
 		iStream.read(m_SlayerAdvancedStr);
 		iStream.read(m_SlayerAdvancedDex);
 		iStream.read(m_SlayerAdvancedInt);
...
// <망각의 수정>
 		oStream.write(m_SlayerAdvancedStr);
 		oStream.write(m_SlayerAdvancedDex);
 		oStream.write(m_SlayerAdvancedInt);
	...
	throw ()
{
	...
	msg << ",Sight:" << (int)m_Sight
		...
		<< ",SlayerAdvancedStr:" << (int)m_SlayerAdvancedStr
		<< ",SlayerAdvancedDex:" << (int)m_SlayerAdvancedDex
		<< ",SlayerAdvancedInt:" << (int)m_SlayerAdvancedInt
#if __CONTENTS(__CONTRIBUTE_SYSTEM)
